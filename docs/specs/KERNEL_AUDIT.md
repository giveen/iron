...
- **`moe`** is the routing/permute/unpermute orchestration in `kernels/moe/orchestration.rs`. The grouped quantized BGEMM lives under the `quantized (gather_*)` row.
