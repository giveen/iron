...
//! GPU correctness for `iron::iron_grouped_gemm_q8` — the GROUPED multi-row
...
use wh_iron_std::kernels::gemm::gemm_q8::iron_grouped_gemm_q8;
...
fn run_case(
    ...
    let mut kernel = iron_grouped_gemm_q8::kernel_ir_for(dt.to_dtype());
