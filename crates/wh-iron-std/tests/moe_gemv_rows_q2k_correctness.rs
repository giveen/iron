...
//! GPU correctness for `iron::iron_moe_gemv_rows_q2k` — proves it matches the
//! PROVEN pool bgemm `iron_moe_gather_bgemm_q2k_mpp` on identical weights +
...
use wh_iron_std::kernels::moe::{
    ...
    moe_gemv_rows_q2k::iron_moe_gemv_rows_q2k,
};
...
fn gemv_rows_q2k_matches_pool_kernel() {
    ...
    let mut kv = iron_moe_gemv_rows_q2k::kernel_ir_for(Dt::F32.to_dtype());
