...
//! GPU correctness for `iron::iron_moe_bgemm_iq2xxs_view` — the ZERO-COPY
...
use wh_iron_std::kernels::moe::moe_bgemm_iq2xxs_view::iron_moe_bgemm_iq2xxs_view;
...
fn bgemm_iq2xxs_view_matches_gemv_oracle() {
    ...
    let mut k = iron_moe_bgemm_iq2xxs_view::kernel_ir_for(Dt::F32.to_dtype());
