...
//! GPU correctness for `iron::iron_sdpa_prefill_d512_sink` — multi-query
...
use wh_iron_std::kernels::sdpa::sdpa_prefill_d512_sink::iron_sdpa_prefill_d512_sink;
...
fn run_case_nq(dt: Dt, n_q: usize, n_query: usize, kv: usize, window: usize, tol: f32) {
    ...
    let mut kern = iron_sdpa_prefill_d512_sink::kernel_ir_for(dt.to_dtype());
