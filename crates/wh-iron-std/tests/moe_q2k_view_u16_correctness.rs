...
use wh_iron_std::kernels::moe::{
    moe_bgemm_q2k_bm64::iron_moe_bgemm_q2k_bm64,
    moe_bgemm_q2k_view_u16_bm64::iron_moe_bgemm_q2k_view_u16_bm64,
};
...
fn q2k_view_u16_bm64_matches_pool() {
    ...
    let run = |buffers: BTreeMap<String, Vec<u8>>, k: wh_iron::core::ir::Kernel| -> Vec<f32> {
        let mut kk = k;
    ...
    let pool_out = run(pb, iron_moe_bgemm_q2k_bm64::kernel_ir_for(DType::F32));
    ...
    let view_out = run(vb, iron_moe_bgemm_q2k_view_u16_bm64::kernel_ir_for(DType::F32));
