...
//!
//! Run: `cargo test --release -p wh-iron-std --test mma_layout_probe -- --nocapture`

#![cfg(target_os = "macos")]

use std::collections::BTreeMap;

use wh_iron::{Context, core::ir::Kernel};
use wh_iron_std::probe::mma_layout_probe::{
    iron_mma_probe_a_identity_b_gemm,
    iron_mma_probe_a_identity_b_identity,
};
...
fn probe_a_identity_b_gemm_convention() {
    run_probe(
        ...
        iron_mma_probe_a_identity_b_gemm::kernel_ir_for(),
    );
}
...
fn probe_a_identity_b_identity_convention() {
    run_probe(
        ...
        iron_mma_probe_a_identity_b_identity::kernel_ir_for(),
    );
}
