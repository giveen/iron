...
//! Isolated check: iron_sdpa_decode_d512_sink with n_kv=1 (single visible
...
use wh_iron_std::kernels::sdpa::sdpa_decode_d512_sink::iron_sdpa_decode_d512_sink;
...
fn sdpa_decode_d512_sink_nkv1_64heads() {
    ...
    let mut kern = iron_sdpa_decode_d512_sink::kernel_ir_for(dt.to_dtype());
    ...
    // Spot-check head 5 specifically (the Iron case that zeroed).
