...
//! GPU correctness for `iron::iron_moe_bgemm_q2k_view` — the ZERO-COPY Q2_K
...
//! PROVEN pool kernel (`iron_moe_gather_bgemm_q2k_mpp`, the validated "Tokyo"
...
use wh_iron_std::kernels::moe::{
    moe_bgemm_q2k_mpp::iron_moe_gather_bgemm_q2k_mpp,
    moe_bgemm_q2k_view::iron_moe_bgemm_q2k_view,
};
...
fn bgemm_q2k_view_matches_pool_kernel() {
    ...
    let mut kp = iron_moe_gather_bgemm_q2k_mpp::kernel_ir_for(Dt::F32.to_dtype());
    ...
    let mut kv = iron_moe_bgemm_q2k_view::kernel_ir_for(Dt::F32.to_dtype());
