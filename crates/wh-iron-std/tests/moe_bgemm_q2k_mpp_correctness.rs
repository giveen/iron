...
//! GPU correctness for `iron::iron_moe_gather_bgemm_q2k_mpp` — prefill Q2_K
...
use wh_iron_std::kernels::moe::moe_bgemm_q2k_mpp::iron_moe_gather_bgemm_q2k_mpp;
...
use wh_iron_std::kernels::quant::gguf::q2_k_qpos;
...
fn bgemm_q2k_mpp_matches_gemv_oracle() {
    ...
    let mut k = iron_moe_gather_bgemm_q2k_mpp::kernel_ir_for(Dt::F32.to_dtype());
