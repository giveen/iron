...
//! `iron_sdpa_prefill_qtiled_d256` (single dispatch, no merge pass).
//!
...
use wh_iron_std::kernels::sdpa::sdpa_prefill_qtiled_d256::iron_sdpa_prefill_qtiled_d256;
...
fn run_qtiled(
    ...
    let mut kern = iron_sdpa_prefill_qtiled_d256::kernel_ir_for(dtype);
