...
//! GPU correctness for `kernels::moe::moe_mpp::iron_moe_gather_qmm_mma_int8_bm16_mpp`.
//!
//! MPP (MetalPerformancePrimitives) int8 MoE BGEMM — same algorithm as
//! `iron_moe_gather_qmm_mma_int4_bm16_mpp` but with pack-aligned 8-bit
...
use wh_iron_std::kernels::moe::moe_mpp;
...
fn run_mpp_int8(
    ...
    let mut k = moe_mpp::iron_moe_gather_qmm_mma_int8_bm16_mpp::kernel_ir_for(dt.to_dtype());
