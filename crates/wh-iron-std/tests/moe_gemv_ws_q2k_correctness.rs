...
//! GPU correctness for `iron::iron_moe_gemv_ws_q2k` — the WEIGHT-STATIONARY
...
//! identical to the proven `iron_moe_gemv_rows_q2k` (same canonical Q2_K
...
use wh_iron_std::kernels::moe::{
    ...
    moe_gemv_ws_q2k::iron_moe_gemv_ws_q2k,
};
...
fn gemv_ws_q2k_matches_gemv_rows() {
    ...
    let mut kr = iron_moe_gemv_rows_q2k::kernel_ir_for(Dt::F32.to_dtype());
    ...
    let mut kw = iron_moe_gemv_ws_q2k::kernel_ir_for(Dt::F32.to_dtype());
