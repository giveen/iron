...
//! GPU correctness for `iron_moe_build_tile_plan_bm32_own` (the "own" leg
...
//! to `iron_moe_build_tile_plan_bm32_paired` instead), while every other
...
fn run_case(counts: &[usize], n_experts: usize) -> (Vec<u32>, Vec<u32>, Vec<u32>, usize, u32, u32) {
    ...
    let mut k = iron_moe_build_tile_plan_bm32_own::kernel_ir();
