...
//! `kernels::moe::moe_gather_qmm::iron_moe_gather_qmm_mma_b{3,5,6,8}`.
//!
//! Same tiled-MMA algorithm as `iron_moe_gather_qmm_mma_int4`, but the
...
use wh_iron_std::kernels::moe::moe_gather_qmm::{
    iron_moe_gather_qmm_mma_b3,
    iron_moe_gather_qmm_mma_b5,
    iron_moe_gather_qmm_mma_b6,
    iron_moe_gather_qmm_mma_b8,
};
...
fn moe_gather_qmm_mma_b3_matches_cpu_oracle() {
    run_bitwidth(3, iron_moe_gather_qmm_mma_b3::kernel_ir_for);
}

#[test]
fn moe_gather_qmm_mma_b5_matches_cpu_oracle() {
    run_bitwidth(5, iron_moe_gather_qmm_mma_b5::kernel_ir_for);
}

#[test]
fn moe_gather_qmm_mma_b6_matches_cpu_oracle() {
    run_bitwidth(6, iron_moe_gather_qmm_mma_b6::kernel_ir_for);
}

#[test]
fn moe_gather_qmm_mma_b8_matches_cpu_oracle() {
    run_bitwidth(8, iron_moe_gather_qmm_mma_b8::kernel_ir_for);
}
