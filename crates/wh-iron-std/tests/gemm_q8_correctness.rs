...
//! GPU correctness for `iron::iron_gemm_q8` — the multi-row Q8_0 tiled GEMM
...
use wh_iron_std::kernels::gemm::gemm_q8::iron_gemm_q8;
...
fn run_case(dt: Dt, in_dim: usize, out_dim: usize, n_rows: usize, tol: f32) {
    ...
    // over in_dim terms, otherwise dominates the diff). Matches iron_gemm's test.
    ...
    let mut kernel = iron_gemm_q8::kernel_ir_for(dt.to_dtype());
