...
//!
//! Dispatches `iron_mpp_matmul_probe` (single threadgroup × single simdgroup,
...
//! the intended signal.
//!
//! Run: `cargo test --release -p wh-iron-std --test mpp_matmul_probe -- --nocapture`
...
use common::gpu_lock;
use wh_iron::Context;
use wh_iron_std::probe::mpp_matmul_probe;
