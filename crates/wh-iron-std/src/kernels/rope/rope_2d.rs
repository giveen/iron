...
/// New-syntax correctness + bench for `iron_rope_2d` (vision 2D positional
...
pub mod kernel_tests {
    ...
    fn test_rope_2d(dt: DType) -> TestSetup {
        ...
        TestSetup::new(iron_rope_2d::kernel_ir_for(dt))
...
/// New-syntax benchmark for `iron_rope_2d`.
pub mod kernel_benches {
    ...
    fn bench_rope_2d(dt: DType) -> BenchSetup {
        ...
        let half = head_dim / 2;
        let quarter = head_dim / 4;
        BenchSetup::new(iron_rope_2d::kernel_ir_for(dt))
            .mode(KernelMode::Grid3D)
