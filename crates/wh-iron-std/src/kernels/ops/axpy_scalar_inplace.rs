...
#[kernel]
pub fn iron_axpy_scalar_inplace<T>(src: Tensor<T>, mut accum: Tensor<T>, #[constexpr] scalar: f32) {
    let i = tid;
...
pub mod kernel_tests {
    ...
    use super::iron_axpy_scalar_inplace;
    ...
    fn setup(n: usize, dt: DType) -> TestSetup {
        ...
        TestSetup::new(iron_axpy_scalar_inplace::kernel_ir_for(dt))
...
pub mod kernel_benches {
    ...
    fn bench_axpy_scalar(dt: DType) -> BenchSetup {
        let n = 4096usize;
        BenchSetup::new(iron_axpy_scalar_inplace::kernel_ir_for(dt))
