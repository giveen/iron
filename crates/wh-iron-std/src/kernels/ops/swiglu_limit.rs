...
//!
//! Drop-in replacement for `iron_swiglu` on the DSv4 gate/up → inner path.

use wh_iron::kernel;

#[kernel]
pub fn iron_swiglu_limit<T>(
    gate: Tensor<T>,
    up: Tensor<T>,
    out: Tensor<T>,
    #[constexpr] limit: f32,
...
pub mod kernel_tests {
    ...
    fn setup(n: usize, dt: DType) -> TestSetup {
        ...
        let expected: Vec<f32> = g_dt
            ...
            .collect();
        TestSetup::new(iron_swiglu_limit::kernel_ir_for(dt))
    ...
    fn test_iron_dsv4_swiglu_limit(dt: DType) -> TestSetup { setup(1024, dt) }
}
...
pub mod kernel_benches {
    ...
    fn bench_dsv4_swiglu_limit(dt: DType) -> BenchSetup {
        ...
        BenchSetup::new(iron_swiglu_limit::kernel_ir_for(dt))
