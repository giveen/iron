...
#[kernel]
pub fn iron_gate_up_swiglu_fused<T>(
    gate_w: Tensor<T>,
    up_w: Tensor<T>,
    x: Tensor<T>,
    mut inner: Tensor<T>,
    ...
    // iron_swiglu's silu reads it. Round g + u back to T then to f32 so
...
pub mod kernel_tests {
    ...
    use super::iron_gate_up_swiglu_fused;
    ...
    fn setup(m: usize, k: usize, dt: DType) -> TestSetup {
        ...
        let expected: Vec<f32> = (0..m)
            ...
            .collect();
        TestSetup::new(iron_gate_up_swiglu_fused::kernel_ir_for(dt))
...
pub mod kernel_benches {
    ...
    fn bench_gus(dt: DType) -> BenchSetup {
        ...
        BenchSetup::new(iron_gate_up_swiglu_fused::kernel_ir_for(dt))
            .mode(KernelMode::Reduction)
