...
pub mod kernel_tests {
    ...
    had_test!(test_hadamard_n64, iron_hadamard_n64, 64);
    had_test!(test_hadamard_n128, iron_hadamard_n128, 128);
    had_test!(test_hadamard_n256, iron_hadamard_n256, 256);
    had_test!(test_hadamard_n512, iron_hadamard_n512, 512);
    had_test!(test_hadamard_n1024, iron_hadamard_n1024, 1024);
}
...
pub mod kernel_benches {
    ...
    had_bench!(bench_hadamard_n64, iron_hadamard_n64, 64);
    had_bench!(bench_hadamard_n128, iron_hadamard_n128, 128);
    had_bench!(bench_hadamard_n256, iron_hadamard_n256, 256);
    had_bench!(bench_hadamard_n512, iron_hadamard_n512, 512);
    had_bench!(bench_hadamard_n1024, iron_hadamard_n1024, 1024);
}
