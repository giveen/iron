...
pub mod kernel_tests {
    ...
    fn test_iron_gather_axis(dt: DType) -> TestSetup {
        ...
        TestSetup::new(iron_gather_axis::kernel_ir_for(dt))
...
/// New-syntax benchmark for `iron_gather_axis`.
pub mod kernel_benches {
    ...
    fn bench_gather_axis(dt: DType) -> BenchSetup {
        ...
        let indices: Vec<u8> = (0..out_len)
            ...
            .collect();
        BenchSetup::new(iron_gather_axis::kernel_ir_for(dt))
