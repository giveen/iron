...
/// which is what the Iron masked-cache-update path needs.
#[kernel]
pub fn iron_masked_scatter<T>(
    mask: Tensor<u32>,
    offsets: Tensor<u32>,
    src: Tensor<T>,
    mut out: Tensor<T>,
...
pub mod kernel_tests {
    ...
    fn test_iron_gather_front(dt: DType) -> TestSetup {
        ...
        TestSetup::new(iron_gather_front::kernel_ir_for(dt))
    ...
    #[test_kernel(dtypes = [f32, f16, bf16], tol = 1e-6)]
    fn test_iron_scatter(dt: DType) -> TestSetup {
        ...
        TestSetup::new(iron_scatter::kernel_ir_for(dt))
    ...
    #[test_kernel(dtypes = [f32, f16, bf16], tol = 1e-6)]
    fn test_iron_masked_scatter(dt: DType) -> TestSetup {
        let n_elems = 64usize;
        ...
        let expected: Vec<f32> = (0..n_elems)
            ...
            .collect();
        TestSetup::new(iron_masked_scatter::kernel_ir_for(dt))
...
pub mod kernel_benches {
    ...
    fn bench_gather_front(dt: DType) -> BenchSetup {
        ...
        let n_elems = n_out * w;
        BenchSetup::new(iron_gather_front::kernel_ir_for(dt))
    ...
    fn bench_scatter(dt: DType) -> BenchSetup {
        ...
        let n_elems = n_upd * w;
        BenchSetup::new(iron_scatter::kernel_ir_for(dt))
    ...
    fn bench_masked_scatter(dt: DType) -> BenchSetup {
        ...
        BenchSetup::new(iron_masked_scatter::kernel_ir_for(dt))
            .buffer(BenchBuffer::from_vec(
                "mask",
