...
#[kernel]
pub fn iron_mhc_sinkhorn_split<T>(
    mixes: Tensor<T>,
    scale: Tensor<f32>,
    base: Tensor<f32>,
    mut pre: Tensor<f32>,
...
pub mod kernel_tests {
    ...
    use super::iron_mhc_sinkhorn_split;
    ...
    fn setup(n_tokens: usize, iters: usize, dt: DType) -> TestSetup {
        ...
        TestSetup::new(iron_mhc_sinkhorn_split::kernel_ir_for(dt))
...
pub mod kernel_benches {
    ...
    fn bench_split(dt: DType) -> BenchSetup {
        ...
        let iters = 1usize;
        BenchSetup::new(iron_mhc_sinkhorn_split::kernel_ir_for(dt))
