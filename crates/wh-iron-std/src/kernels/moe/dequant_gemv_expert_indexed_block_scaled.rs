...
//!
//! Block-scaled counterpart of `iron/dequant_gemv_expert_indexed.rs` (which
...
//! dispatch `iron_nvfp8_dequant_gemv_expert_indexed` with `QFormat::Fp8E4m3`.
//!
//! ## Memory layout
//!
...
/// through `kernels/primitives.rs`. Produces `iron_<FMT>_dequant_gemv_expert_indexed`.
#[kernel(variants(
...
pub mod kernel_tests {
    ...
    fn test_mxfp4_dequant_gemv_expert_indexed(dt: DType) -> TestSetup {
        expert_setup(
            iron_mxfp4_dequant_gemv_expert_indexed::kernel_ir_for(dt),
            QFormat::Mxfp4,
            4,
            4,
            256,
    ...
    fn test_nvfp4_dequant_gemv_expert_indexed(dt: DType) -> TestSetup {
        expert_setup(
            iron_nvfp4_dequant_gemv_expert_indexed::kernel_ir_for(dt),
            QFormat::Nvfp4,
            4,
            4,
            256,
    ...
    fn test_mxfp8_e4m3_dequant_gemv_expert_indexed(dt: DType) -> TestSetup {
        expert_setup(
            iron_mxfp8_e4m3_dequant_gemv_expert_indexed::kernel_ir_for(dt),
            QFormat::Mxfp8E4,
            4,
            4,
            256,
    ...
    fn test_mxfp8_e5m2_dequant_gemv_expert_indexed(dt: DType) -> TestSetup {
        expert_setup(
            iron_mxfp8_e5m2_dequant_gemv_expert_indexed::kernel_ir_for(dt),
            QFormat::Mxfp8E5,
            4,
            4,
            256,
    ...
    fn test_nvfp8_dequant_gemv_expert_indexed(dt: DType) -> TestSetup {
        expert_setup(
            iron_nvfp8_dequant_gemv_expert_indexed::kernel_ir_for(dt),
            QFormat::Nvfp8,
            4,
            4,
            256,
    ...
    fn test_fp4_dequant_gemv_expert_indexed(dt: DType) -> TestSetup {
        expert_setup(
            iron_fp4_dequant_gemv_expert_indexed::kernel_ir_for(dt),
            QFormat::Fp4,
            4,
            4,
            256,
    ...
    fn test_fp8_e5m2_dequant_gemv_expert_indexed(dt: DType) -> TestSetup {
        expert_setup(
            iron_fp8_e5m2_dequant_gemv_expert_indexed::kernel_ir_for(dt),
            QFormat::Fp8E5m2,
            4,
            4,
            256,
    ...
    fn test_int8_dequant_gemv_expert_indexed(dt: DType) -> TestSetup {
        expert_setup(
            iron_int8_dequant_gemv_expert_indexed::kernel_ir_for(dt),
            QFormat::Int8,
            4,
            4,
            256,
    ...
    fn test_int2_dequant_gemv_expert_indexed(dt: DType) -> TestSetup {
        expert_setup(
            iron_int2_dequant_gemv_expert_indexed::kernel_ir_for(dt),
            QFormat::Int2,
            4,
            4,
            256,
    ...
    fn test_int3_dequant_gemv_expert_indexed(dt: DType) -> TestSetup {
        expert_setup(
            iron_int3_dequant_gemv_expert_indexed::kernel_ir_for(dt),
            QFormat::Int3,
            4,
            4,
            256,
    ...
    fn test_int4_dequant_gemv_expert_indexed(dt: DType) -> TestSetup {
        expert_setup(
            iron_int4_dequant_gemv_expert_indexed::kernel_ir_for(dt),
            QFormat::Int4,
            4,
            4,
            256,
    ...
    fn test_int5_dequant_gemv_expert_indexed(dt: DType) -> TestSetup {
        expert_setup(
            iron_int5_dequant_gemv_expert_indexed::kernel_ir_for(dt),
            QFormat::Int5,
            4,
            4,
            256,
    ...
    fn test_int6_dequant_gemv_expert_indexed(dt: DType) -> TestSetup {
        expert_setup(
            iron_int6_dequant_gemv_expert_indexed::kernel_ir_for(dt),
            QFormat::Int6,
            4,
            4,
            256,
    ...
    fn test_mxint2_dequant_gemv_expert_indexed(dt: DType) -> TestSetup {
        expert_setup(
            iron_mxint2_dequant_gemv_expert_indexed::kernel_ir_for(dt),
            QFormat::Mxint2,
            4,
            4,
            256,
    ...
    fn test_mxint3_dequant_gemv_expert_indexed(dt: DType) -> TestSetup {
        expert_setup(
            iron_mxint3_dequant_gemv_expert_indexed::kernel_ir_for(dt),
            QFormat::Mxint3,
            4,
            4,
            256,
    ...
    fn test_mxint4_dequant_gemv_expert_indexed(dt: DType) -> TestSetup {
        expert_setup(
            iron_mxint4_dequant_gemv_expert_indexed::kernel_ir_for(dt),
            QFormat::Mxint4,
            4,
            4,
            256,
    ...
    fn test_mxint5_dequant_gemv_expert_indexed(dt: DType) -> TestSetup {
        expert_setup(
            iron_mxint5_dequant_gemv_expert_indexed::kernel_ir_for(dt),
            QFormat::Mxint5,
            4,
            4,
            256,
    ...
    fn test_mxint6_dequant_gemv_expert_indexed(dt: DType) -> TestSetup {
        expert_setup(
            iron_mxint6_dequant_gemv_expert_indexed::kernel_ir_for(dt),
            QFormat::Mxint6,
            4,
            4,
            256,
    ...
    fn test_mxint8_dequant_gemv_expert_indexed(dt: DType) -> TestSetup {
        expert_setup(
            iron_mxint8_dequant_gemv_expert_indexed::kernel_ir_for(dt),
            QFormat::Mxint8,
            4,
            4,
            256,
    ...
    fn test_nvfp8_f16_dequant_gemv_expert_indexed(dt: DType) -> TestSetup {
        expert_setup(
            iron_nvfp8_f16_dequant_gemv_expert_indexed::kernel_ir_for(dt),
            QFormat::Nvfp8F16,
            4,
            4,
            256,
    ...
    fn test_fp4_f16_dequant_gemv_expert_indexed(dt: DType) -> TestSetup {
        expert_setup(
            iron_fp4_f16_dequant_gemv_expert_indexed::kernel_ir_for(dt),
            QFormat::Fp4F16,
            4,
            4,
            256,
    ...
    fn test_fp8_e5m2_f16_dequant_gemv_expert_indexed(dt: DType) -> TestSetup {
        expert_setup(
            iron_fp8_e5m2_f16_dequant_gemv_expert_indexed::kernel_ir_for(dt),
            QFormat::Fp8E5m2F16,
            4,
            4,
            256,
    ...
    fn test_int2_f16_dequant_gemv_expert_indexed(dt: DType) -> TestSetup {
        expert_setup(
            iron_int2_f16_dequant_gemv_expert_indexed::kernel_ir_for(dt),
            QFormat::Int2F16,
            4,
            4,
            256,
    ...
    fn test_int3_f16_dequant_gemv_expert_indexed(dt: DType) -> TestSetup {
        expert_setup(
            iron_int3_f16_dequant_gemv_expert_indexed::kernel_ir_for(dt),
            QFormat::Int3F16,
            4,
            4,
            256,
    ...
    fn test_int4_f16_dequant_gemv_expert_indexed(dt: DType) -> TestSetup {
        expert_setup(
            iron_int4_f16_dequant_gemv_expert_indexed::kernel_ir_for(dt),
            QFormat::Int4F16,
            4,
            4,
            256,
    ...
    fn test_int5_f16_dequant_gemv_expert_indexed(dt: DType) -> TestSetup {
        expert_setup(
            iron_int5_f16_dequant_gemv_expert_indexed::kernel_ir_for(dt),
            QFormat::Int5F16,
            4,
            4,
            256,
    ...
    fn test_int6_f16_dequant_gemv_expert_indexed(dt: DType) -> TestSetup {
        expert_setup(
            iron_int6_f16_dequant_gemv_expert_indexed::kernel_ir_for(dt),
            QFormat::Int6F16,
            4,
            4,
            256,
    ...
    fn test_int8_f16_dequant_gemv_expert_indexed(dt: DType) -> TestSetup {
        expert_setup(
            iron_int8_f16_dequant_gemv_expert_indexed::kernel_ir_for(dt),
            QFormat::Int8F16,
            4,
            4,
            256,
