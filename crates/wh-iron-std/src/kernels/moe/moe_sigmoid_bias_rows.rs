...
//!
//! Sibling of `iron_moe_sigmoid_bias` (single-token); used by Hy3 Path B
...
#[kernel]
pub fn iron_moe_sigmoid_bias_rows<T>(
    logits: Tensor<T>,
    bias: Tensor<T>,
...
pub mod kernel_tests {
    ...
    use super::iron_moe_sigmoid_bias_rows;
    ...
    fn setup(dt: DType, t_rows: usize, n_experts: usize) -> TestSetup {
        ...
        TestSetup::new(iron_moe_sigmoid_bias_rows::kernel_ir_for(dt))
...
pub mod kernel_benches {
    ...
    fn bench_moe_sigmoid_bias_rows(dt: DType) -> BenchSetup {
        ...
        let total = t_rows * n_experts;
        BenchSetup::new(iron_moe_sigmoid_bias_rows::kernel_ir_for(dt))
