...
//! twin of iron_moe_gemv_ws_iq2xxs. Dequants each expert's weight row
...
pub mod kernel_benches {
    ...
    use super::iron_moe_gemv_ws_q2k;
    ...
    fn bench_gemv_ws_q2k(dt: DType) -> BenchSetup {
        ...
        BenchSetup::new(iron_moe_gemv_ws_q2k::kernel_ir_for(dt))
