...
//!
//! Structure is identical to `moe_mpp::iron_moe_gather_qmm_mma_int4_bm16_mpp`
...
pub fn iron_moe_gather_bgemm_iq2xxs_mpp<T>(
    x: Tensor<T>,
    qs: Tensor<u32>,
    d_f32: Tensor<f32>,
    grid: Tensor<u8>,
...
pub mod kernel_benches {
    ...
    use super::iron_moe_gather_bgemm_iq2xxs_mpp;
    ...
    fn bench_bgemm_iq2xxs_mpp(dt: DType) -> BenchSetup {
        ...
        BenchSetup::new(iron_moe_gather_bgemm_iq2xxs_mpp::kernel_ir_for(dt))
