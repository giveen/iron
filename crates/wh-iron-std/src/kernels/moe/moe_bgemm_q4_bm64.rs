...
//! `iron_moe_bgemm_q2k_bm64`: processes a 64-row M-tile whose rows are
...
pub fn iron_moe_bgemm_q4_bm64<T>(
    x: Tensor<T>,
    qs: Tensor<u32>,
    scales: Tensor<f16>,
    indices: Tensor<u32>,
...
pub mod kernel_tests {
    ...
    use super::iron_moe_bgemm_q4_bm64;
    ...
    fn setup(dt: DType) -> TestSetup {
        ...
        let _ = bpr;
        TestSetup::new(iron_moe_bgemm_q4_bm64::kernel_ir_for(dt))
