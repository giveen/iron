...
//! `iron_moe_sigmoid_bias` (192 experts, top-8). See `docs/specs/HY3_MOE_PREP.md`.
//!
...
//! `iron_moe_router_topk` (masked argmax passes, one simdgroup/row).
//!
...
#[kernel]
pub fn iron_moe_router_topk_biased<T>(
...
pub mod kernel_tests {
    ...
    use super::iron_moe_router_topk_biased;
    ...
    fn setup(dt: DType, n_experts: usize, k: usize) -> TestSetup {
        ...
        TestSetup::new(iron_moe_router_topk_biased::kernel_ir_for(dt))
...
pub mod kernel_benches {
    ...
    use super::{iron_moe_router_topk_biased, iron_remap_u32};

    #[bench(dtypes = [f32, f16, bf16])]
    fn bench_moe_router_topk_biased(dt: DType) -> BenchSetup {
        let n_experts = 256usize;
        let k = 6usize;
        BenchSetup::new(iron_moe_router_topk_biased::kernel_ir_for(dt))
            .mode(KernelMode::Reduction)
    ...
    fn bench_remap_u32(_dt: DType) -> BenchSetup {
        let n = 6usize;
        BenchSetup::new(iron_remap_u32::kernel_ir())
