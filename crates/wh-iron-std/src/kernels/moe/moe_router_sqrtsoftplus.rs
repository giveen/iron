...
//!
//! Compared to the sister `iron_moe_router_sigmoid_bias`:
...
// for `iron bench`.
#[kernel]
pub fn iron_moe_router_sqrtsoftplus(
    logits: Tensor<f32>,
    bias: Tensor<f32>,
...
pub mod kernel_tests {
    ...
    use super::iron_moe_router_sqrtsoftplus;
    ...
    fn setup(n_experts: usize) -> TestSetup {
        ...
        TestSetup::new(iron_moe_router_sqrtsoftplus::kernel_ir())
...
pub mod kernel_benches {
    ...
    fn bench_router(_dt: DType) -> BenchSetup {
        ...
        BenchSetup::new(iron_moe_router_sqrtsoftplus::kernel_ir())
