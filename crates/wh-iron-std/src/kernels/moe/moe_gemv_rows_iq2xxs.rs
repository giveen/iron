...
//! (iron_moe_gather_gemv_iq2xxs, ~270 GB/s) applied to a whole batch of
//! M = N*topK (token,expert) rows in ONE dispatch, instead of the
//! coop-tile MMA bgemm (iron_moe_bgemm_iq2xxs_mpp, ~4-10 GB/s — 15-70x
...
#[kernel]
pub fn iron_moe_gemv_rows_iq2xxs<T>(
    x: Tensor<T>,
    qs_all: Tensor<u32>,
    d_all: Tensor<f32>,
...
pub mod kernel_benches {
    ...
    use super::iron_moe_gemv_rows_iq2xxs;
    ...
    fn bench_gemv_rows_iq2xxs(dt: DType) -> BenchSetup {
        ...
        BenchSetup::new(iron_moe_gemv_rows_iq2xxs::kernel_ir_for(dt))
