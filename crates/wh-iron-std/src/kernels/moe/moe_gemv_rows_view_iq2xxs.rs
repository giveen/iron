...
pub fn iron_moe_gemv_rows_view_iq2xxs<T>(
    x: Tensor<T>,
    view_u8: Tensor<u8>,
    grid: Tensor<u8>,
    signs: Tensor<u8>,
...
#[kernel]
#[allow(clippy::too_many_arguments)]
pub fn iron_moe_gemv_rows_view_u16_iq2xxs<T>(
    x: Tensor<T>,
    view_u16: Tensor<u16>,
    grid: Tensor<u8>,
    signs: Tensor<u8>,
...
pub mod kernel_benches {
    ...
    use super::iron_moe_gemv_rows_view_u16_iq2xxs;
    ...
    fn bench_gemv_rows_view_u16_iq2xxs(dt: DType) -> BenchSetup {
        ...
        BenchSetup::new(iron_moe_gemv_rows_view_u16_iq2xxs::kernel_ir_for(dt))
...
pub mod kernel_benches_old {
    ...
    use super::iron_moe_gemv_rows_view_iq2xxs;
    ...
    fn bench_gemv_rows_view_iq2xxs(dt: DType) -> BenchSetup {
        ...
        let nblk = m_out * (k_in / 256);
        let view_bytes = n_experts * nblk * 66;
        BenchSetup::new(iron_moe_gemv_rows_view_iq2xxs::kernel_ir_for(dt))
            .mode(KernelMode::Reduction)
            .buffer(BenchBuffer::random("x", m_total * k_in, dt))
