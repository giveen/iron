...
//! iron_moe_gemv_rows_iq2xxs. Replaces the slow coop-tile bgemm
...
pub fn iron_moe_gemv_rows_q2k<T>(
    x: Tensor<T>,
    qs: Tensor<u32>,
    scales: Tensor<u8>,
    d_f32: Tensor<f32>,
...
pub mod kernel_benches {
    ...
    use super::iron_moe_gemv_rows_q2k;
    ...
    fn bench_gemv_rows_q2k(dt: DType) -> BenchSetup {
        ...
        BenchSetup::new(iron_moe_gemv_rows_q2k::kernel_ir_for(dt))
