...
//!
//! ## Inputs (Q2_K split format — produced by the Iron loader)
//!
//! ```text
...
//! `gguf_dequant_q2_k::iron_gguf_dequant_q2_k`.

use wh_iron::kernel;

#[kernel]
pub fn iron_moe_gather_down_q2k<T>(
    inners_all: Tensor<T>,
    qs_all: Tensor<u32>,
...
pub mod kernel_benches {
    ...
    use super::iron_moe_gather_down_q2k;
    ...
    fn bench_gather_down_q2k(dt: DType) -> BenchSetup {
        ...
        BenchSetup::new(iron_moe_gather_down_q2k::kernel_ir_for(dt))
