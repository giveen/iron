...
//!
//! `iron_gated_delta_prep_chunk`'s "Phase 0a" (per-head RMSNorm of q/k) does
...
//!   matching `iron_gated_delta_prep_chunk`.
...
#[kernel]
pub fn iron_gated_delta_qknorm_prepass<T>(
...
mod tests {
    ...
    fn dump() {
        ...
        let mut k = iron_gated_delta_qknorm_prepass::kernel_ir_for(DType::F32);
...
/// RMSNorm math as `iron_gated_delta_prep_chunk`'s Phase 0a, evaluated once
...
pub mod kernel_tests {
    ...
    use super::iron_gated_delta_qknorm_prepass;
    ...
    fn setup(
        ...
        TestSetup::new(iron_gated_delta_qknorm_prepass::kernel_ir_for(dt))
    ...
    fn test_iron_gated_delta_qknorm_prepass_gqa(dt: DType) -> TestSetup {
    ...
    fn test_iron_gated_delta_qknorm_prepass_no_gqa(dt: DType) -> TestSetup {
...
pub mod kernel_benches {
    ...
    fn bench_gated_delta_qknorm_prepass(dt: DType) -> BenchSetup {
        ...
        BenchSetup::new(iron_gated_delta_qknorm_prepass::kernel_ir_for(dt))
            .mode(KernelMode::Reduction)
