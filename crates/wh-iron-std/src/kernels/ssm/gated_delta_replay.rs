...
//!
//! Two kernels:
//!   - `iron_gated_delta_step_record` — the standard GatedDelta forward step
//!     that *also* writes each step's `delta_t` to a `delta_log` tape.
//!   - `iron_state_replay` — re-folds the accepted prefix `[0, accepted)` of
...
pub fn iron_gated_delta_step_record<T>(
    q: Tensor<T>,
    k: Tensor<T>,
    v: Tensor<T>,
    g: Tensor<T>,
...
pub mod kernel_tests {
    ...
    use super::{iron_gated_delta_step_record_d64_32_2_2, iron_state_replay_d64_32_2_2};
    ...
    fn record_setup(dt: DType) -> TestSetup {
        ...
        TestSetup::new(iron_gated_delta_step_record_d64_32_2_2::kernel_ir_for(dt))
    ...
    fn replay_setup(dt: DType) -> TestSetup {
        ...
        TestSetup::new(iron_state_replay_d64_32_2_2::kernel_ir_for(dt))
            .mode(KernelMode::Grid3D)
...
pub mod kernel_benches {
    ...
    use super::{
        iron_gated_delta_step_record_d64_32_2_2,
        iron_gated_delta_step_record_d192_128_4_4,
        iron_state_replay_d64_32_2_2,
        iron_state_replay_d192_128_4_4,
    };
    ...
    fn bench_gated_delta_record(dt: DType) -> BenchSetup {
        ...
        let n_total = batch * HV;
        BenchSetup::new(iron_gated_delta_step_record_d64_32_2_2::kernel_ir_for(dt))
            .mode(KernelMode::Grid3D)
    ...
    fn bench_gated_delta_replay(dt: DType) -> BenchSetup {
        ...
        let n_total = batch * HV;
        BenchSetup::new(iron_state_replay_d64_32_2_2::kernel_ir_for(dt))
            .mode(KernelMode::Grid3D)
    ...
    fn bench_gated_delta_record_d192_128_4_4(dt: DType) -> BenchSetup {
        ...
        BenchSetup::new(iron_gated_delta_step_record_d192_128_4_4::kernel_ir_for(dt))
            .mode(KernelMode::Grid3D)
    ...
    fn bench_gated_delta_replay_d192_128_4_4(dt: DType) -> BenchSetup {
        let (batch, t_log, accepted) = (1usize, 8usize, 8usize);
        let n_total = batch * P_HV;
        BenchSetup::new(iron_state_replay_d192_128_4_4::kernel_ir_for(dt))
            .mode(KernelMode::Grid3D)
