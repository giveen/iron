...
#[kernel]
pub fn iron_logits_temperature<T>(inp: Tensor<T>, out: Tensor<T>, #[constexpr] temperature: f32) {
    let i = program_id::<0>();
...
#[kernel]
pub fn iron_logits_repetition_penalty<T>(
    mut logits: Tensor<T>,
...
pub mod kernel_tests {
    ...
    use super::{iron_logits_repetition_penalty, iron_logits_temperature};
    ...
    fn test_logits_temperature(dt: DType) -> TestSetup {
        ...
        TestSetup::new(iron_logits_temperature::kernel_ir_for(dt))
    ...
    fn test_logits_repetition_penalty(dt: DType) -> TestSetup {
        ...
        TestSetup::new(iron_logits_repetition_penalty::kernel_ir_for(dt))
            .mode(KernelMode::Grid3D)
...
pub mod kernel_benches {
    ...
    fn bench_logits_temperature(dt: DType) -> BenchSetup {
        let n = 152_064usize;
        BenchSetup::new(iron_logits_temperature::kernel_ir_for(dt))
            .mode(KernelMode::Grid3D)
    ...
    fn bench_logits_repetition_penalty(dt: DType) -> BenchSetup {
        ...
        BenchSetup::new(iron_logits_repetition_penalty::kernel_ir_for(dt))
            .mode(KernelMode::Grid3D)
