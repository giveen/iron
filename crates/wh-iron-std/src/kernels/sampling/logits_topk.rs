...
#[kernel]
pub fn iron_logits_topk_mask<T>(inp: Tensor<T>, out: Tensor<T>, #[constexpr] threshold: f32) {
    let i = program_id::<0>();
...
pub mod kernel_tests {
    ...
    use super::iron_logits_topk_mask;
    ...
    fn test_logits_topk_mask(dt: DType) -> TestSetup {
        ...
        TestSetup::new(iron_logits_topk_mask::kernel_ir_for(dt))
...
/// New-syntax benchmark for `iron_logits_topk_mask` at Qwen3 vocab scale
...
pub mod kernel_benches {
    ...
    fn bench_logits_topk_mask(dt: DType) -> BenchSetup {
        let n = 152_064usize;
        BenchSetup::new(iron_logits_topk_mask::kernel_ir_for(dt))
            .mode(KernelMode::Grid3D)
