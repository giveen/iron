...
//!
//! Same algorithm as `iron_gguf_dequant_iq2_xxs` but reads `qs` from
...
#[kernel]
pub fn iron_gguf_dequant_iq2_xxs_raw<T>(
    raw_bytes: Tensor<u8>,
    d_f32: Tensor<f32>,
    grid: Tensor<u8>,
    signs: Tensor<u8>,
...
pub mod kernel_tests {
    ...
    use super::iron_gguf_dequant_iq2_xxs_raw;

    #[test]
    fn codegen_iq2_xxs_raw_smoke() {
        for dt in [DType::F32, DType::F16, DType::BF16] {
            let ir = iron_gguf_dequant_iq2_xxs_raw::kernel_ir_for(dt);
...
pub mod kernel_benches {
    ...
    fn bench_iq2_xxs_raw(dt: DType) -> BenchSetup {
        ...
        let n_blocks = n / 256;
        BenchSetup::new(iron_gguf_dequant_iq2_xxs_raw::kernel_ir_for(dt))
