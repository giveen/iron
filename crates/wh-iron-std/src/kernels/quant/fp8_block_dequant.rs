...
#[kernel]
pub fn iron_fp8_block_dequant<T>(
...
pub mod kernel_tests {
    ...
    use super::iron_fp8_block_dequant;
    ...
    /// (`kernels::quant::format`'s E4M3 element, the GGUF/MLX micro-float scales) routes
    ...
    fn setup(m: usize, n: usize, dt: DType) -> TestSetup {
        ...
        TestSetup::new(iron_fp8_block_dequant::kernel_ir_for(dt))
...
pub mod kernel_benches {
    ...
    fn bench_fp8(dt: DType) -> BenchSetup {
        ...
        let block_rows = m / 128;
        let block_cols = n / 128;
        BenchSetup::new(iron_fp8_block_dequant::kernel_ir_for(dt))
