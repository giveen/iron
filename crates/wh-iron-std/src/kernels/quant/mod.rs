...
//! Quantization formats — the registry of every precision wh-iron supports.
//!
...
//! |--------|--------|------------|--------|
//! | OCP / NVIDIA / legacy / symmetric-int / MXINT / fp16-twin | [`format`] ([`QFormat`](format::QFormat)) | wh-iron's own block-scaled formats (nvfp4, mxfp4, mxfp8, nvfp8, int2–8, mxint*, …) | planar, symmetric (`element·block_scale·global`) |
...
//! | MLX affine | `kernels::gemm::quantized` | MLX checkpoint interop (asymmetric int w/ zero-point) | group, affine |
//!
...
// Dequant kernels migrated from iron/ + mlx/ (the codec/format above are the
