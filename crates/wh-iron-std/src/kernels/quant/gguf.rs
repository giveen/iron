...
//!
//! [`QFormat`] is wh-iron's **own** block-scaled layout: *planar*
//! (`codes[]` + `scales[]`), *symmetric* (`element · block_scale · global`, no
//! zero-point), packed end-to-end by wh-iron. GGUF formats are
...
//!
//! The GGUF dequant kernels (`iron/gguf_dequant_*`, `iron/moe_*_{q2k,iq2xxs}`,
