...
// dequant calls.
#[kernel]
pub fn iron_gguf_dequant_iq2_xxs<T>(
    qs_u32: Tensor<u32>,
    d_f32: Tensor<f32>,
    grid: Tensor<u8>,
    signs: Tensor<u8>,
...
pub mod kernel_tests {
    ...
    use super::iron_gguf_dequant_iq2_xxs;
    ...
    fn codegen_iq2_xxs_smoke() {
        for dt in [DType::F32, DType::F16, DType::BF16] {
            let ir = iron_gguf_dequant_iq2_xxs::kernel_ir_for(dt);
    ...
    /// grid + ksigns tables ship on the Iron loader side. Once they're
    ...
    fn _placeholder_setup(n_blocks: usize, dt: DType) -> TestSetup {
        let n = n_blocks * 256;
        TestSetup::new(iron_gguf_dequant_iq2_xxs::kernel_ir_for(dt))
...
pub mod kernel_benches {
    ...
    fn bench_iq2_xxs(dt: DType) -> BenchSetup {
        ...
        let n_blocks = n / 256;
        BenchSetup::new(iron_gguf_dequant_iq2_xxs::kernel_ir_for(dt))
