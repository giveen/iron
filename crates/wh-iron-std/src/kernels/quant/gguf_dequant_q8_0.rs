...
//! wh-iron DSL doesn't expose today), the GGUF loader splits each
...
// fn below registers this kernel for `iron bench` without the legacy
// path.
#[kernel]
pub fn iron_gguf_dequant_q8_0<T>(
    qs_signed: Tensor<u8>,
    scales: Tensor<f32>,
    out: Tensor<T>,
...
pub mod kernel_tests {
    ...
    use super::iron_gguf_dequant_q8_0;
    ...
    fn setup(n_blocks: usize, dt: DType) -> TestSetup {
        ...
        TestSetup::new(iron_gguf_dequant_q8_0::kernel_ir_for(dt))
...
pub mod kernel_benches {
    ...
    fn bench_q8_0(dt: DType) -> BenchSetup {
        ...
        let n_blocks = n / 32;
        BenchSetup::new(iron_gguf_dequant_q8_0::kernel_ir_for(dt))
