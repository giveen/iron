...
#[kernel]
pub fn iron_sdpa_bidirectional_d128_relpos<T>(
    q: Tensor<T>,
    k: Tensor<T>,
    v: Tensor<T>,
    bias: Tensor<f32>,
...
pub mod kernel_tests {
    ...
    use super::iron_sdpa_bidirectional_d128_relpos;
    ...
    fn setup(dt: DType) -> TestSetup {
        ...
        TestSetup::new(iron_sdpa_bidirectional_d128_relpos::kernel_ir_for(dt))
    ...
    fn test_iron_sdpa_bidirectional_d128_relpos(dt: DType) -> TestSetup { setup(dt) }
}
...
pub mod kernel_benches {
    ...
    fn bench_d128_relpos(dt: DType) -> BenchSetup {
        ...
        let bytes = (2 * n_query * n_q_heads * head_dim + 2 * n_kv_heads * n_kv * head_dim)
            * dt.size_bytes();
        BenchSetup::new(iron_sdpa_bidirectional_d128_relpos::kernel_ir_for(dt))
            .mode(KernelMode::Reduction)
