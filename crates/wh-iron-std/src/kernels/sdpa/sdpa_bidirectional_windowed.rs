...
//! 27..31 are bounds-masked) — identical to `iron_sdpa_bidirectional_d80`.
//!
//! ## Window contract
//!
...
#[kernel]
pub fn iron_sdpa_bidirectional_windowed_d80<T>(
    q: Tensor<T>,
    k: Tensor<T>,
    v: Tensor<T>,
...
pub mod kernel_tests {
    ...
    use super::iron_sdpa_bidirectional_windowed_d80;
    ...
    fn setup(dt: DType, n_query: usize, win: usize) -> TestSetup {
        ...
        TestSetup::new(iron_sdpa_bidirectional_windowed_d80::kernel_ir_for(dt))
...
pub mod kernel_benches {
    ...
    fn bench_windowed_d80(dt: DType) -> BenchSetup {
        ...
        let bytes = (2 * n_query * n_q_heads * head_dim + 2 * n_kv_heads * n_query * head_dim)
            * dt.size_bytes();
        BenchSetup::new(iron_sdpa_bidirectional_windowed_d80::kernel_ir_for(dt))
            .mode(KernelMode::Reduction)
