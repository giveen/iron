...
///
/// Produces kernels: `iron_aura_score_int2`, `iron_aura_score_int3`, `iron_aura_score_int4`,
/// `iron_aura_score_int6`, `iron_aura_score_int8`.
///
...
pub mod kernel_tests {
    ...
    use super::iron_aura_score_int4;
    ...
    fn test_aura_score_int4(dt: DType) -> TestSetup {
        ...
        TestSetup::new(iron_aura_score_int4::kernel_ir_for(dt))
...
pub mod kernel_benches {
    ...
    fn bench_aura_score(dt: DType) -> BenchSetup {
        setup(
            BenchSetup::new(iron_aura_score_intBITS::kernel_ir_for(dt)),
            128,
            BITS,
            32,
            8,
