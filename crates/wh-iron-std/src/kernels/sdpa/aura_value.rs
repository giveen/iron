...
///
/// Produces kernels: `iron_aura_value_int2`, `iron_aura_value_int3`, `iron_aura_value_int4`,
/// `iron_aura_value_int6`, `iron_aura_value_int8`.
///
...
pub mod kernel_tests {
    ...
    use super::iron_aura_value_int4;
    ...
    fn value_setup(dt: DType, q_heads: usize, kv_heads: usize, sparse_threshold: f32) -> TestSetup {
        ...
        TestSetup::new(iron_aura_value_int4::kernel_ir_for(dt))
...
pub mod kernel_benches {
    ...
    fn bench_aura_value(dt: DType) -> BenchSetup {
        setup(
            BenchSetup::new(iron_aura_value_intBITS::kernel_ir_for(dt)),
            128,
            BITS,
            32,
            8,
