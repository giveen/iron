...
#[kernel]
pub fn iron_sdpa_decode_sink_buf<T>(
    q: Tensor<T>,
    k: Tensor<T>,
    v: Tensor<T>,
    sink: Tensor<f32>,
...
pub mod kernel_tests {
    ...
    use super::iron_sdpa_decode_sink_buf;
    ...
    fn setup(dt: DType, head_dim: usize) -> TestSetup {
        ...
        TestSetup::new(iron_sdpa_decode_sink_buf::kernel_ir_for(dt))
...
pub mod kernel_benches {
    ...
    fn bench_sdpa_decode_sink_buf(dt: DType) -> BenchSetup {
        ...
        BenchSetup::new(iron_sdpa_decode_sink_buf::kernel_ir_for(dt))
            .mode(KernelMode::Reduction)
