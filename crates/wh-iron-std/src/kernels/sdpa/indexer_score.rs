...
//! follow-up `iron_indexer_topk` does the bitonic top-512.
//!
//! ## Dispatch
//!
...
pub mod kernel_tests {
    ...
    fn setup(n_heads: usize, d_idx: usize, n_kv: usize, dt: DType) -> TestSetup {
        ...
        TestSetup::new(iron_indexer_score::kernel_ir_for(dt))
...
pub mod kernel_benches {
    ...
    fn bench_indexer(dt: DType) -> BenchSetup {
        ...
        BenchSetup::new(iron_indexer_score::kernel_ir_for(dt))
