...
pub mod kernel_tests {
    ...
    use super::iron_compressor_pool;
    ...
    fn setup(pool_len: usize, head_dim: usize, dt: DType) -> TestSetup {
        ...
        TestSetup::new(iron_compressor_pool::kernel_ir_for(dt))
...
pub mod kernel_benches {
    ...
    fn bench_csa(dt: DType) -> BenchSetup {
        ...
        BenchSetup::new(iron_compressor_pool::kernel_ir_for(dt))
