...
pub fn iron_gated_rms_norm_pregate_qgemv_int4_fast<T>(
    y: Tensor<f32>,
    z: Tensor<T>,
    ...
    //
    // Byte-for-byte identical to `iron_gated_rms_norm_qgemv_int4_fast`
...
pub mod kernel_tests {
    ...
    use super::{
        iron_gated_rms_norm_pregate_qgemv_int4_fast,
    ...
    fn setup(hv: usize, dv: usize, out_dim: usize, group_size: usize, dt: DType) -> TestSetup {
        ...
        TestSetup::new(iron_gated_rms_norm_pregate_qgemv_int4_fast::kernel_ir_for(dt))
...
pub mod kernel_benches {
    ...
    use super::iron_gated_rms_norm_pregate_qgemv_int4_fast;
    ...
    fn bench_gated_rms_norm_pregate_qgemv_int4_fast(dt: DType) -> BenchSetup {
        ...
        let u32_per_row = in_dim / 8;
        let n_groups = in_dim / group_size;
        BenchSetup::new(iron_gated_rms_norm_pregate_qgemv_int4_fast::kernel_ir_for(dt))
            .mode(KernelMode::Reduction)
