...
//! the gated-RMSNorm staging of `iron/gated_rms_norm_qgemv.rs` fused with the
...
/// `kernels/primitives.rs`. Produces `iron_<FMT>_gated_rms_norm_qgemv`.
#[kernel(variants(
...
pub mod kernel_tests {
    ...
    fn test_mxfp4_gated_rms_norm_qgemv(dt: DType) -> TestSetup {
        gated_setup(
            iron_mxfp4_gated_rms_norm_qgemv::kernel_ir_for(dt),
            QFormat::Mxfp4,
            4,
            128,
            4,
    ...
    fn test_nvfp4_gated_rms_norm_qgemv(dt: DType) -> TestSetup {
        gated_setup(
            iron_nvfp4_gated_rms_norm_qgemv::kernel_ir_for(dt),
            QFormat::Nvfp4,
            4,
            128,
            4,
    ...
    fn test_mxfp8_e4m3_gated_rms_norm_qgemv(dt: DType) -> TestSetup {
        gated_setup(
            iron_mxfp8_e4m3_gated_rms_norm_qgemv::kernel_ir_for(dt),
            QFormat::Mxfp8E4,
            4,
            128,
            4,
    ...
    fn test_mxfp8_e5m2_gated_rms_norm_qgemv(dt: DType) -> TestSetup {
        gated_setup(
            iron_mxfp8_e5m2_gated_rms_norm_qgemv::kernel_ir_for(dt),
            QFormat::Mxfp8E5,
            4,
            128,
            4,
    ...
    fn test_nvfp8_gated_rms_norm_qgemv(dt: DType) -> TestSetup {
        gated_setup(
            iron_nvfp8_gated_rms_norm_qgemv::kernel_ir_for(dt),
            QFormat::Nvfp8,
            4,
            128,
            4,
    ...
    fn test_fp4_gated_rms_norm_qgemv(dt: DType) -> TestSetup {
        gated_setup(iron_fp4_gated_rms_norm_qgemv::kernel_ir_for(dt), QFormat::Fp4, 4, 128, 4, dt)
    }
    ...
    fn test_fp8_e5m2_gated_rms_norm_qgemv(dt: DType) -> TestSetup {
        gated_setup(
            iron_fp8_e5m2_gated_rms_norm_qgemv::kernel_ir_for(dt),
            QFormat::Fp8E5m2,
            4,
            128,
            4,
    ...
    fn test_int8_gated_rms_norm_qgemv(dt: DType) -> TestSetup {
        gated_setup(iron_int8_gated_rms_norm_qgemv::kernel_ir_for(dt), QFormat::Int8, 4, 128, 4, dt)
    }
    ...
    fn test_int2_gated_rms_norm_qgemv(dt: DType) -> TestSetup {
        gated_setup(iron_int2_gated_rms_norm_qgemv::kernel_ir_for(dt), QFormat::Int2, 4, 128, 4, dt)
    }
    #[test_kernel(dtypes = [f32, f16, bf16], tol = [5e-3, 5e-2, 2e-1])]
    fn test_int3_gated_rms_norm_qgemv(dt: DType) -> TestSetup {
        gated_setup(iron_int3_gated_rms_norm_qgemv::kernel_ir_for(dt), QFormat::Int3, 4, 128, 4, dt)
    }
    #[test_kernel(dtypes = [f32, f16, bf16], tol = [5e-3, 5e-2, 2e-1])]
    fn test_int4_gated_rms_norm_qgemv(dt: DType) -> TestSetup {
        gated_setup(iron_int4_gated_rms_norm_qgemv::kernel_ir_for(dt), QFormat::Int4, 4, 128, 4, dt)
    }
    #[test_kernel(dtypes = [f32, f16, bf16], tol = [5e-3, 5e-2, 2e-1])]
    fn test_int5_gated_rms_norm_qgemv(dt: DType) -> TestSetup {
        gated_setup(iron_int5_gated_rms_norm_qgemv::kernel_ir_for(dt), QFormat::Int5, 4, 128, 4, dt)
    }
    #[test_kernel(dtypes = [f32, f16, bf16], tol = [5e-3, 5e-2, 2e-1])]
    fn test_int6_gated_rms_norm_qgemv(dt: DType) -> TestSetup {
        gated_setup(iron_int6_gated_rms_norm_qgemv::kernel_ir_for(dt), QFormat::Int6, 4, 128, 4, dt)
    }
    #[test_kernel(dtypes = [f32, f16, bf16], tol = [5e-3, 5e-2, 2e-1])]
    fn test_mxint2_gated_rms_norm_qgemv(dt: DType) -> TestSetup {
        gated_setup(
            iron_mxint2_gated_rms_norm_qgemv::kernel_ir_for(dt),
            QFormat::Mxint2,
            4,
            128,
            4,
    ...
    fn test_mxint3_gated_rms_norm_qgemv(dt: DType) -> TestSetup {
        gated_setup(
            iron_mxint3_gated_rms_norm_qgemv::kernel_ir_for(dt),
            QFormat::Mxint3,
            4,
            128,
            4,
    ...
    fn test_mxint4_gated_rms_norm_qgemv(dt: DType) -> TestSetup {
        gated_setup(
            iron_mxint4_gated_rms_norm_qgemv::kernel_ir_for(dt),
            QFormat::Mxint4,
            4,
            128,
            4,
    ...
    fn test_mxint5_gated_rms_norm_qgemv(dt: DType) -> TestSetup {
        gated_setup(
            iron_mxint5_gated_rms_norm_qgemv::kernel_ir_for(dt),
            QFormat::Mxint5,
            4,
            128,
            4,
    ...
    fn test_mxint6_gated_rms_norm_qgemv(dt: DType) -> TestSetup {
        gated_setup(
            iron_mxint6_gated_rms_norm_qgemv::kernel_ir_for(dt),
            QFormat::Mxint6,
            4,
            128,
            4,
    ...
    fn test_mxint8_gated_rms_norm_qgemv(dt: DType) -> TestSetup {
        gated_setup(
            iron_mxint8_gated_rms_norm_qgemv::kernel_ir_for(dt),
            QFormat::Mxint8,
            4,
            128,
            4,
    ...
    fn test_nvfp8_f16_gated_rms_norm_qgemv(dt: DType) -> TestSetup {
        gated_setup(
            iron_nvfp8_f16_gated_rms_norm_qgemv::kernel_ir_for(dt),
            QFormat::Nvfp8F16,
            4,
            128,
            4,
    ...
    fn test_fp4_f16_gated_rms_norm_qgemv(dt: DType) -> TestSetup {
        gated_setup(
            iron_fp4_f16_gated_rms_norm_qgemv::kernel_ir_for(dt),
            QFormat::Fp4F16,
            4,
            128,
            4,
    ...
    fn test_fp8_e5m2_f16_gated_rms_norm_qgemv(dt: DType) -> TestSetup {
        gated_setup(
            iron_fp8_e5m2_f16_gated_rms_norm_qgemv::kernel_ir_for(dt),
            QFormat::Fp8E5m2F16,
            4,
            128,
            4,
    ...
    fn test_int2_f16_gated_rms_norm_qgemv(dt: DType) -> TestSetup {
        gated_setup(
            iron_int2_f16_gated_rms_norm_qgemv::kernel_ir_for(dt),
            QFormat::Int2F16,
            4,
            128,
            4,
    ...
    fn test_int3_f16_gated_rms_norm_qgemv(dt: DType) -> TestSetup {
        gated_setup(
            iron_int3_f16_gated_rms_norm_qgemv::kernel_ir_for(dt),
            QFormat::Int3F16,
            4,
            128,
            4,
    ...
    fn test_int4_f16_gated_rms_norm_qgemv(dt: DType) -> TestSetup {
        gated_setup(
            iron_int4_f16_gated_rms_norm_qgemv::kernel_ir_for(dt),
            QFormat::Int4F16,
            4,
            128,
            4,
    ...
    fn test_int5_f16_gated_rms_norm_qgemv(dt: DType) -> TestSetup {
        gated_setup(
            iron_int5_f16_gated_rms_norm_qgemv::kernel_ir_for(dt),
            QFormat::Int5F16,
            4,
            128,
            4,
    ...
    fn test_int6_f16_gated_rms_norm_qgemv(dt: DType) -> TestSetup {
        gated_setup(
            iron_int6_f16_gated_rms_norm_qgemv::kernel_ir_for(dt),
            QFormat::Int6F16,
            4,
            128,
            4,
    ...
    fn test_int8_f16_gated_rms_norm_qgemv(dt: DType) -> TestSetup {
        gated_setup(
            iron_int8_f16_gated_rms_norm_qgemv::kernel_ir_for(dt),
            QFormat::Int8F16,
            4,
            128,
            4,
...
pub mod kernel_benches {
    ...
    fn bench_fp4_gated(dt: DType) -> BenchSetup {
        gated_bench(
            iron_fp4_gated_rms_norm_qgemv::kernel_ir_for(dt),
            QFormat::Fp4,
            16,
            128,
            2048,
    ...
    fn bench_int8_gated(dt: DType) -> BenchSetup {
        gated_bench(
            iron_int8_gated_rms_norm_qgemv::kernel_ir_for(dt),
            QFormat::Int8,
            16,
            128,
            2048,
    ...
    fn bench_int2_gated(dt: DType) -> BenchSetup {
        gated_bench(
            iron_int2_gated_rms_norm_qgemv::kernel_ir_for(dt),
            QFormat::Int2,
            16,
            128,
            2048,
    ...
    fn bench_int3_gated(dt: DType) -> BenchSetup {
        gated_bench(
            iron_int3_gated_rms_norm_qgemv::kernel_ir_for(dt),
            QFormat::Int3,
            16,
            128,
            2048,
    ...
    fn bench_int4_gated(dt: DType) -> BenchSetup {
        gated_bench(
            iron_int4_gated_rms_norm_qgemv::kernel_ir_for(dt),
            QFormat::Int4,
            16,
            128,
            2048,
    ...
    fn bench_int5_gated(dt: DType) -> BenchSetup {
        gated_bench(
            iron_int5_gated_rms_norm_qgemv::kernel_ir_for(dt),
            QFormat::Int5,
            16,
            128,
            2048,
    ...
    fn bench_int6_gated(dt: DType) -> BenchSetup {
        gated_bench(
            iron_int6_gated_rms_norm_qgemv::kernel_ir_for(dt),
            QFormat::Int6,
            16,
            128,
            2048,
