...
//! of `iron/patch_embed.rs`. Patch embedding is a linear projection
...
/// `kernels/primitives.rs`. Produces `iron_<FMT>_patch_embed`.
#[kernel(variants(
...
pub mod kernel_tests {
    ...
    fn test_mxfp4_patch_embed(dt: DType) -> TestSetup {
        patch_setup(
            iron_mxfp4_patch_embed::kernel_ir_for(dt),
            QFormat::Mxfp4,
            4,
            16,
            16,
    ...
    fn test_nvfp4_patch_embed(dt: DType) -> TestSetup {
        patch_setup(
            iron_nvfp4_patch_embed::kernel_ir_for(dt),
            QFormat::Nvfp4,
            4,
            16,
            16,
    ...
    fn test_fp4_patch_embed(dt: DType) -> TestSetup {
        patch_setup(iron_fp4_patch_embed::kernel_ir_for(dt), QFormat::Fp4, 4, 16, 16, 8, 8, 64, dt)
    }
    #[test_kernel(dtypes = [f32, f16, bf16], tol = [5e-3, 5e-2, 2e-1])]
    fn test_mxfp8_e4m3_patch_embed(dt: DType) -> TestSetup {
        patch_setup(
            iron_mxfp8_e4m3_patch_embed::kernel_ir_for(dt),
            QFormat::Mxfp8E4,
            4,
            16,
            16,
    ...
    fn test_mxfp8_e5m2_patch_embed(dt: DType) -> TestSetup {
        patch_setup(
            iron_mxfp8_e5m2_patch_embed::kernel_ir_for(dt),
            QFormat::Mxfp8E5,
            4,
            16,
            16,
    ...
    fn test_fp8_e5m2_patch_embed(dt: DType) -> TestSetup {
        patch_setup(
            iron_fp8_e5m2_patch_embed::kernel_ir_for(dt),
            QFormat::Fp8E5m2,
            4,
            16,
            16,
    ...
    fn test_nvfp8_patch_embed(dt: DType) -> TestSetup {
        patch_setup(
            iron_nvfp8_patch_embed::kernel_ir_for(dt),
            QFormat::Nvfp8,
            4,
            16,
            16,
    ...
    fn test_int8_patch_embed(dt: DType) -> TestSetup {
        patch_setup(
            iron_int8_patch_embed::kernel_ir_for(dt),
            QFormat::Int8,
            4,
            16,
            16,
    ...
    fn test_int2_patch_embed(dt: DType) -> TestSetup {
        patch_setup(
            iron_int2_patch_embed::kernel_ir_for(dt),
            QFormat::Int2,
            4,
            16,
            16,
    ...
    fn test_int3_patch_embed(dt: DType) -> TestSetup {
        patch_setup(
            iron_int3_patch_embed::kernel_ir_for(dt),
            QFormat::Int3,
            4,
            16,
            16,
    ...
    fn test_int4_patch_embed(dt: DType) -> TestSetup {
        patch_setup(
            iron_int4_patch_embed::kernel_ir_for(dt),
            QFormat::Int4,
            4,
            16,
            16,
    ...
    fn test_int5_patch_embed(dt: DType) -> TestSetup {
        patch_setup(
            iron_int5_patch_embed::kernel_ir_for(dt),
            QFormat::Int5,
            4,
            16,
            16,
    ...
    fn test_int6_patch_embed(dt: DType) -> TestSetup {
        patch_setup(
            iron_int6_patch_embed::kernel_ir_for(dt),
            QFormat::Int6,
            4,
            16,
            16,
    ...
    fn test_mxint2_patch_embed(dt: DType) -> TestSetup {
        patch_setup(
            iron_mxint2_patch_embed::kernel_ir_for(dt),
            QFormat::Mxint2,
            4,
            16,
            16,
    ...
    fn test_mxint3_patch_embed(dt: DType) -> TestSetup {
        patch_setup(
            iron_mxint3_patch_embed::kernel_ir_for(dt),
            QFormat::Mxint3,
            4,
            16,
            16,
    ...
    fn test_mxint4_patch_embed(dt: DType) -> TestSetup {
        patch_setup(
            iron_mxint4_patch_embed::kernel_ir_for(dt),
            QFormat::Mxint4,
            4,
            16,
            16,
    ...
    fn test_mxint5_patch_embed(dt: DType) -> TestSetup {
        patch_setup(
            iron_mxint5_patch_embed::kernel_ir_for(dt),
            QFormat::Mxint5,
            4,
            16,
            16,
    ...
    fn test_mxint6_patch_embed(dt: DType) -> TestSetup {
        patch_setup(
            iron_mxint6_patch_embed::kernel_ir_for(dt),
            QFormat::Mxint6,
            4,
            16,
            16,
    ...
    fn test_mxint8_patch_embed(dt: DType) -> TestSetup {
        patch_setup(
            iron_mxint8_patch_embed::kernel_ir_for(dt),
            QFormat::Mxint8,
            4,
            16,
            16,
    ...
    fn test_nvfp8_f16_patch_embed(dt: DType) -> TestSetup {
        patch_setup(
            iron_nvfp8_f16_patch_embed::kernel_ir_for(dt),
            QFormat::Nvfp8F16,
            4,
            16,
            16,
    ...
    fn test_fp4_f16_patch_embed(dt: DType) -> TestSetup {
        patch_setup(
            iron_fp4_f16_patch_embed::kernel_ir_for(dt),
            QFormat::Fp4F16,
            4,
            16,
            16,
    ...
    fn test_fp8_e5m2_f16_patch_embed(dt: DType) -> TestSetup {
        patch_setup(
            iron_fp8_e5m2_f16_patch_embed::kernel_ir_for(dt),
            QFormat::Fp8E5m2F16,
            4,
            16,
            16,
    ...
    fn test_int2_f16_patch_embed(dt: DType) -> TestSetup {
        patch_setup(
            iron_int2_f16_patch_embed::kernel_ir_for(dt),
            QFormat::Int2F16,
            4,
            16,
            16,
    ...
    fn test_int3_f16_patch_embed(dt: DType) -> TestSetup {
        patch_setup(
            iron_int3_f16_patch_embed::kernel_ir_for(dt),
            QFormat::Int3F16,
            4,
            16,
            16,
    ...
    fn test_int4_f16_patch_embed(dt: DType) -> TestSetup {
        patch_setup(
            iron_int4_f16_patch_embed::kernel_ir_for(dt),
            QFormat::Int4F16,
            4,
            16,
            16,
    ...
    fn test_int5_f16_patch_embed(dt: DType) -> TestSetup {
        patch_setup(
            iron_int5_f16_patch_embed::kernel_ir_for(dt),
            QFormat::Int5F16,
            4,
            16,
            16,
    ...
    fn test_int6_f16_patch_embed(dt: DType) -> TestSetup {
        patch_setup(
            iron_int6_f16_patch_embed::kernel_ir_for(dt),
            QFormat::Int6F16,
            4,
            16,
            16,
    ...
    fn test_int8_f16_patch_embed(dt: DType) -> TestSetup {
        patch_setup(
            iron_int8_f16_patch_embed::kernel_ir_for(dt),
            QFormat::Int8F16,
            4,
            16,
            16,
...
pub mod kernel_benches {
    ...
    patch_bench_fmt!(bench_mxfp4, iron_mxfp4_patch_embed::kernel_ir_for, QFormat::Mxfp4);
    patch_bench_fmt!(bench_nvfp4, iron_nvfp4_patch_embed::kernel_ir_for, QFormat::Nvfp4);
    patch_bench_fmt!(bench_fp4, iron_fp4_patch_embed::kernel_ir_for, QFormat::Fp4);
    patch_bench_fmt!(
        bench_mxfp8_e4m3,
        iron_mxfp8_e4m3_patch_embed::kernel_ir_for,
        QFormat::Mxfp8E4
    );
    patch_bench_fmt!(
        bench_mxfp8_e5m2,
        iron_mxfp8_e5m2_patch_embed::kernel_ir_for,
        QFormat::Mxfp8E5
    );
    patch_bench_fmt!(bench_fp8_e5m2, iron_fp8_e5m2_patch_embed::kernel_ir_for, QFormat::Fp8E5m2);
    patch_bench_fmt!(bench_nvfp8, iron_nvfp8_patch_embed::kernel_ir_for, QFormat::Nvfp8);
    patch_bench_fmt!(bench_int8, iron_int8_patch_embed::kernel_ir_for, QFormat::Int8);
    // Symmetric sub-byte ints (FP32 group scale) + MXINT (E8M0 block scale) +
    // MXINT8 (8-bit, E8M0). Same Grid3D geometry as the rest of the family.
    patch_bench_fmt!(bench_int2, iron_int2_patch_embed::kernel_ir_for, QFormat::Int2);
    patch_bench_fmt!(bench_int3, iron_int3_patch_embed::kernel_ir_for, QFormat::Int3);
    patch_bench_fmt!(bench_int4, iron_int4_patch_embed::kernel_ir_for, QFormat::Int4);
    patch_bench_fmt!(bench_int5, iron_int5_patch_embed::kernel_ir_for, QFormat::Int5);
    patch_bench_fmt!(bench_int6, iron_int6_patch_embed::kernel_ir_for, QFormat::Int6);
    patch_bench_fmt!(bench_mxint2, iron_mxint2_patch_embed::kernel_ir_for, QFormat::Mxint2);
    patch_bench_fmt!(bench_mxint3, iron_mxint3_patch_embed::kernel_ir_for, QFormat::Mxint3);
    patch_bench_fmt!(bench_mxint4, iron_mxint4_patch_embed::kernel_ir_for, QFormat::Mxint4);
    patch_bench_fmt!(bench_mxint5, iron_mxint5_patch_embed::kernel_ir_for, QFormat::Mxint5);
    patch_bench_fmt!(bench_mxint6, iron_mxint6_patch_embed::kernel_ir_for, QFormat::Mxint6);
    patch_bench_fmt!(bench_mxint8, iron_mxint8_patch_embed::kernel_ir_for, QFormat::Mxint8);
    ...
    patch_bench_fmt!(bench_nvfp8_f16, iron_nvfp8_f16_patch_embed::kernel_ir_for, QFormat::Nvfp8F16);
    patch_bench_fmt!(
        bench_fp8_e4m3_f16,
        iron_nvfp8_f16_patch_embed::kernel_ir_for,
        QFormat::Fp8E4m3F16
    );
    patch_bench_fmt!(bench_fp4_f16, iron_fp4_f16_patch_embed::kernel_ir_for, QFormat::Fp4F16);
    patch_bench_fmt!(
        bench_fp8_e5m2_f16,
        iron_fp8_e5m2_f16_patch_embed::kernel_ir_for,
        QFormat::Fp8E5m2F16
    );
    patch_bench_fmt!(bench_int2_f16, iron_int2_f16_patch_embed::kernel_ir_for, QFormat::Int2F16);
    patch_bench_fmt!(bench_int3_f16, iron_int3_f16_patch_embed::kernel_ir_for, QFormat::Int3F16);
    patch_bench_fmt!(bench_int4_f16, iron_int4_f16_patch_embed::kernel_ir_for, QFormat::Int4F16);
    patch_bench_fmt!(bench_int5_f16, iron_int5_f16_patch_embed::kernel_ir_for, QFormat::Int5F16);
    patch_bench_fmt!(bench_int6_f16, iron_int6_f16_patch_embed::kernel_ir_for, QFormat::Int6F16);
    patch_bench_fmt!(bench_int8_f16, iron_int8_f16_patch_embed::kernel_ir_for, QFormat::Int8F16);
}
