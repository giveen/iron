...
//! templates:
//!
//! - `iron/patch_embed_mma.rs` (dense cooperative patch embed) supplies the
...
//!   dispatch grid.
//!
//! - `iron/conv2d_mma_block_scaled.rs` (block-scaled MMA conv) supplies the
...
/// bit-stream `(global_h*patch_dim + tap)*BITS`. Produces `iron_<FMT>_patch_embed_mma`.
#[kernel(variants(
...
pub mod kernel_tests {
    ...
    fn test_mxfp4_patch_embed_mma(dt: DType) -> TestSetup {
        mma_setup(
            iron_mxfp4_patch_embed_mma::kernel_ir_for(dt),
            QFormat::Mxfp4,
            4,
            32,
            32,
    ...
    fn test_nvfp4_patch_embed_mma(dt: DType) -> TestSetup {
        mma_setup(
            iron_nvfp4_patch_embed_mma::kernel_ir_for(dt),
            QFormat::Nvfp4,
            4,
            32,
            32,
    ...
    fn test_fp4_patch_embed_mma(dt: DType) -> TestSetup {
        mma_setup(
            iron_fp4_patch_embed_mma::kernel_ir_for(dt),
            QFormat::Fp4,
            4,
            32,
            32,
    ...
    fn test_mxfp8_e4m3_patch_embed_mma(dt: DType) -> TestSetup {
        mma_setup(
            iron_mxfp8_e4m3_patch_embed_mma::kernel_ir_for(dt),
            QFormat::Mxfp8E4,
            4,
            32,
            32,
    ...
    fn test_mxfp8_e5m2_patch_embed_mma(dt: DType) -> TestSetup {
        mma_setup(
            iron_mxfp8_e5m2_patch_embed_mma::kernel_ir_for(dt),
            QFormat::Mxfp8E5,
            4,
            32,
            32,
    ...
    fn test_nvfp8_patch_embed_mma(dt: DType) -> TestSetup {
        mma_setup(
            iron_nvfp8_patch_embed_mma::kernel_ir_for(dt),
            QFormat::Nvfp8,
            4,
            32,
            32,
    ...
    fn test_fp8_e5m2_patch_embed_mma(dt: DType) -> TestSetup {
        mma_setup(
            iron_fp8_e5m2_patch_embed_mma::kernel_ir_for(dt),
            QFormat::Fp8E5m2,
            4,
            32,
            32,
    ...
    fn test_int8_patch_embed_mma(dt: DType) -> TestSetup {
        mma_setup(
            iron_int8_patch_embed_mma::kernel_ir_for(dt),
            QFormat::Int8,
            4,
            32,
            32,
    ...
    fn test_int2_patch_embed_mma(dt: DType) -> TestSetup {
        mma_setup(
            iron_int2_patch_embed_mma::kernel_ir_for(dt),
            QFormat::Int2,
            4,
            32,
            32,
    ...
    fn test_int3_patch_embed_mma(dt: DType) -> TestSetup {
        mma_setup(
            iron_int3_patch_embed_mma::kernel_ir_for(dt),
            QFormat::Int3,
            4,
            32,
            32,
    ...
    fn test_int4_patch_embed_mma(dt: DType) -> TestSetup {
        mma_setup(
            iron_int4_patch_embed_mma::kernel_ir_for(dt),
            QFormat::Int4,
            4,
            32,
            32,
    ...
    fn test_int5_patch_embed_mma(dt: DType) -> TestSetup {
        mma_setup(
            iron_int5_patch_embed_mma::kernel_ir_for(dt),
            QFormat::Int5,
            4,
            32,
            32,
    ...
    fn test_int6_patch_embed_mma(dt: DType) -> TestSetup {
        mma_setup(
            iron_int6_patch_embed_mma::kernel_ir_for(dt),
            QFormat::Int6,
            4,
            32,
            32,
    ...
    fn test_mxint2_patch_embed_mma(dt: DType) -> TestSetup {
        mma_setup(
            iron_mxint2_patch_embed_mma::kernel_ir_for(dt),
            QFormat::Mxint2,
            4,
            32,
            32,
    ...
    fn test_mxint3_patch_embed_mma(dt: DType) -> TestSetup {
        mma_setup(
            iron_mxint3_patch_embed_mma::kernel_ir_for(dt),
            QFormat::Mxint3,
            4,
            32,
            32,
    ...
    fn test_mxint4_patch_embed_mma(dt: DType) -> TestSetup {
        mma_setup(
            iron_mxint4_patch_embed_mma::kernel_ir_for(dt),
            QFormat::Mxint4,
            4,
            32,
            32,
    ...
    fn test_mxint5_patch_embed_mma(dt: DType) -> TestSetup {
        mma_setup(
            iron_mxint5_patch_embed_mma::kernel_ir_for(dt),
            QFormat::Mxint5,
            4,
            32,
            32,
    ...
    fn test_mxint6_patch_embed_mma(dt: DType) -> TestSetup {
        mma_setup(
            iron_mxint6_patch_embed_mma::kernel_ir_for(dt),
            QFormat::Mxint6,
            4,
            32,
            32,
    ...
    fn test_mxint8_patch_embed_mma(dt: DType) -> TestSetup {
        mma_setup(
            iron_mxint8_patch_embed_mma::kernel_ir_for(dt),
            QFormat::Mxint8,
            4,
            32,
            32,
    ...
    fn test_nvfp8_f16_patch_embed_mma(dt: DType) -> TestSetup {
        mma_setup(
            iron_nvfp8_f16_patch_embed_mma::kernel_ir_for(dt),
            QFormat::Nvfp8F16,
            4,
            32,
            32,
    ...
    fn test_fp4_f16_patch_embed_mma(dt: DType) -> TestSetup {
        mma_setup(
            iron_fp4_f16_patch_embed_mma::kernel_ir_for(dt),
            QFormat::Fp4F16,
            4,
            32,
            32,
    ...
    fn test_fp8_e5m2_f16_patch_embed_mma(dt: DType) -> TestSetup {
        mma_setup(
            iron_fp8_e5m2_f16_patch_embed_mma::kernel_ir_for(dt),
            QFormat::Fp8E5m2F16,
            4,
            32,
            32,
    ...
    fn test_int2_f16_patch_embed_mma(dt: DType) -> TestSetup {
        mma_setup(
            iron_int2_f16_patch_embed_mma::kernel_ir_for(dt),
            QFormat::Int2F16,
            4,
            32,
            32,
    ...
    fn test_int3_f16_patch_embed_mma(dt: DType) -> TestSetup {
        mma_setup(
            iron_int3_f16_patch_embed_mma::kernel_ir_for(dt),
            QFormat::Int3F16,
            4,
            32,
            32,
    ...
    fn test_int4_f16_patch_embed_mma(dt: DType) -> TestSetup {
        mma_setup(
            iron_int4_f16_patch_embed_mma::kernel_ir_for(dt),
            QFormat::Int4F16,
            4,
            32,
            32,
    ...
    fn test_int5_f16_patch_embed_mma(dt: DType) -> TestSetup {
        mma_setup(
            iron_int5_f16_patch_embed_mma::kernel_ir_for(dt),
            QFormat::Int5F16,
            4,
            32,
            32,
    ...
    fn test_int6_f16_patch_embed_mma(dt: DType) -> TestSetup {
        mma_setup(
            iron_int6_f16_patch_embed_mma::kernel_ir_for(dt),
            QFormat::Int6F16,
            4,
            32,
            32,
    ...
    fn test_int8_f16_patch_embed_mma(dt: DType) -> TestSetup {
        mma_setup(
            iron_int8_f16_patch_embed_mma::kernel_ir_for(dt),
            QFormat::Int8F16,
            4,
            32,
            32,
...
pub mod kernel_benches {
    ...
    fn mma_bench(
        ...
        let (codes_len, codes_dt) = if fmt.element_bits() == 8 {
            ...
            (
                crate::kernels::quant::format::bitstream_words(n_weight, fmt.element_bits()),
                DType::U32,
            )
        };
        let scales_dt = match fmt.scale_kind() {
