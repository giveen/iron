...
//! int4 fused variant `iron_batched_4_qgemv_fast`, but with the simple
//! one-output-row-per-TG Reduction geometry of the block-scaled Q/K/V variant
//! `iron_*_batched_qkv_qgemv` rather than the perf-tuned mask-without-shift path.
//!
...
//! only sees four base pointers. This matches `iron_batched_4_qgemv_fast`.
//!
//! ## DISPATCH INVARIANTS
//!
...
/// `kernels/primitives.rs`. Produces `iron_<FMT>_batched_4_qgemv`.
#[kernel(variants(
...
pub mod kernel_tests {
    ...
    fn test_mxfp4_batched_4_qgemv(dt: DType) -> TestSetup {
        batched_4_setup(
            iron_mxfp4_batched_4_qgemv::kernel_ir_for(dt),
            QFormat::Mxfp4,
            16,
            4,
            4,
    ...
    fn test_nvfp4_batched_4_qgemv(dt: DType) -> TestSetup {
        batched_4_setup(
            iron_nvfp4_batched_4_qgemv::kernel_ir_for(dt),
            QFormat::Nvfp4,
            16,
            4,
            4,
    ...
    fn test_mxfp8_e4m3_batched_4_qgemv(dt: DType) -> TestSetup {
        batched_4_setup(
            iron_mxfp8_e4m3_batched_4_qgemv::kernel_ir_for(dt),
            QFormat::Mxfp8E4,
            16,
            4,
            4,
    ...
    fn test_mxfp8_e5m2_batched_4_qgemv(dt: DType) -> TestSetup {
        batched_4_setup(
            iron_mxfp8_e5m2_batched_4_qgemv::kernel_ir_for(dt),
            QFormat::Mxfp8E5,
            16,
            4,
            4,
    ...
    fn test_nvfp8_batched_4_qgemv(dt: DType) -> TestSetup {
        batched_4_setup(
            iron_nvfp8_batched_4_qgemv::kernel_ir_for(dt),
            QFormat::Nvfp8,
            16,
            4,
            4,
    ...
    fn test_fp4_batched_4_qgemv(dt: DType) -> TestSetup {
        batched_4_setup(
            iron_fp4_batched_4_qgemv::kernel_ir_for(dt),
            QFormat::Fp4,
            16,
            4,
            4,
    ...
    fn test_fp8_e5m2_batched_4_qgemv(dt: DType) -> TestSetup {
        batched_4_setup(
            iron_fp8_e5m2_batched_4_qgemv::kernel_ir_for(dt),
            QFormat::Fp8E5m2,
            16,
            4,
            4,
    ...
    fn test_int8_batched_4_qgemv(dt: DType) -> TestSetup {
        batched_4_setup(
            iron_int8_batched_4_qgemv::kernel_ir_for(dt),
            QFormat::Int8,
            16,
            4,
            4,
    ...
    fn test_int2_batched_4_qgemv(dt: DType) -> TestSetup {
        batched_4_setup(
            iron_int2_batched_4_qgemv::kernel_ir_for(dt),
            QFormat::Int2,
            16,
            4,
            4,
    ...
    fn test_int3_batched_4_qgemv(dt: DType) -> TestSetup {
        batched_4_setup(
            iron_int3_batched_4_qgemv::kernel_ir_for(dt),
            QFormat::Int3,
            16,
            4,
            4,
    ...
    fn test_int4_batched_4_qgemv(dt: DType) -> TestSetup {
        batched_4_setup(
            iron_int4_batched_4_qgemv::kernel_ir_for(dt),
            QFormat::Int4,
            16,
            4,
            4,
    ...
    fn test_int5_batched_4_qgemv(dt: DType) -> TestSetup {
        batched_4_setup(
            iron_int5_batched_4_qgemv::kernel_ir_for(dt),
            QFormat::Int5,
            16,
            4,
            4,
    ...
    fn test_int6_batched_4_qgemv(dt: DType) -> TestSetup {
        batched_4_setup(
            iron_int6_batched_4_qgemv::kernel_ir_for(dt),
            QFormat::Int6,
            16,
            4,
            4,
    ...
    fn test_mxint2_batched_4_qgemv(dt: DType) -> TestSetup {
        batched_4_setup(
            iron_mxint2_batched_4_qgemv::kernel_ir_for(dt),
            QFormat::Mxint2,
            16,
            4,
            4,
    ...
    fn test_mxint3_batched_4_qgemv(dt: DType) -> TestSetup {
        batched_4_setup(
            iron_mxint3_batched_4_qgemv::kernel_ir_for(dt),
            QFormat::Mxint3,
            16,
            4,
            4,
    ...
    fn test_mxint4_batched_4_qgemv(dt: DType) -> TestSetup {
        batched_4_setup(
            iron_mxint4_batched_4_qgemv::kernel_ir_for(dt),
            QFormat::Mxint4,
            16,
            4,
            4,
    ...
    fn test_mxint5_batched_4_qgemv(dt: DType) -> TestSetup {
        batched_4_setup(
            iron_mxint5_batched_4_qgemv::kernel_ir_for(dt),
            QFormat::Mxint5,
            16,
            4,
            4,
    ...
    fn test_mxint6_batched_4_qgemv(dt: DType) -> TestSetup {
        batched_4_setup(
            iron_mxint6_batched_4_qgemv::kernel_ir_for(dt),
            QFormat::Mxint6,
            16,
            4,
            4,
    ...
    fn test_mxint8_batched_4_qgemv(dt: DType) -> TestSetup {
        batched_4_setup(
            iron_mxint8_batched_4_qgemv::kernel_ir_for(dt),
            QFormat::Mxint8,
            16,
            4,
            4,
    ...
    fn test_nvfp8_f16_batched_4_qgemv(dt: DType) -> TestSetup {
        batched_4_setup(
            iron_nvfp8_f16_batched_4_qgemv::kernel_ir_for(dt),
            QFormat::Nvfp8F16,
            16,
            4,
            4,
    ...
    fn test_fp4_f16_batched_4_qgemv(dt: DType) -> TestSetup {
        batched_4_setup(
            iron_fp4_f16_batched_4_qgemv::kernel_ir_for(dt),
            QFormat::Fp4F16,
            16,
            4,
            4,
    ...
    fn test_fp8_e5m2_f16_batched_4_qgemv(dt: DType) -> TestSetup {
        batched_4_setup(
            iron_fp8_e5m2_f16_batched_4_qgemv::kernel_ir_for(dt),
            QFormat::Fp8E5m2F16,
            16,
            4,
            4,
    ...
    fn test_int2_f16_batched_4_qgemv(dt: DType) -> TestSetup {
        batched_4_setup(
            iron_int2_f16_batched_4_qgemv::kernel_ir_for(dt),
            QFormat::Int2F16,
            16,
            4,
            4,
    ...
    fn test_int3_f16_batched_4_qgemv(dt: DType) -> TestSetup {
        batched_4_setup(
            iron_int3_f16_batched_4_qgemv::kernel_ir_for(dt),
            QFormat::Int3F16,
            16,
            4,
            4,
    ...
    fn test_int4_f16_batched_4_qgemv(dt: DType) -> TestSetup {
        batched_4_setup(
            iron_int4_f16_batched_4_qgemv::kernel_ir_for(dt),
            QFormat::Int4F16,
            16,
            4,
            4,
    ...
    fn test_int5_f16_batched_4_qgemv(dt: DType) -> TestSetup {
        batched_4_setup(
            iron_int5_f16_batched_4_qgemv::kernel_ir_for(dt),
            QFormat::Int5F16,
            16,
            4,
            4,
    ...
    fn test_int6_f16_batched_4_qgemv(dt: DType) -> TestSetup {
        batched_4_setup(
            iron_int6_f16_batched_4_qgemv::kernel_ir_for(dt),
            QFormat::Int6F16,
            16,
            4,
            4,
    ...
    fn test_int8_f16_batched_4_qgemv(dt: DType) -> TestSetup {
        batched_4_setup(
            iron_int8_f16_batched_4_qgemv::kernel_ir_for(dt),
            QFormat::Int8F16,
            16,
            4,
            4,
