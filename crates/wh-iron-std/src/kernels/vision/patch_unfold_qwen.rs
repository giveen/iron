...
#[kernel]
pub fn iron_patch_unfold_qwen<T>(
    frames: Tensor<T>,
    out: Tensor<T>,
...
pub mod kernel_tests {
    ...
    use super::iron_patch_unfold_qwen;
    ...
    /// CPU oracle — mirrors Iron's Qwen `unfoldPatches` exactly.
    ...
    fn setup(
        ...
        TestSetup::new(iron_patch_unfold_qwen::kernel_ir_for(dt))
...
pub mod kernel_benches {
    ...
    fn bench_patch_unfold_qwen(dt: DType) -> BenchSetup {
        ...
        let n_out = n_patches * patch_dim_padded;
        BenchSetup::new(iron_patch_unfold_qwen::kernel_ir_for(dt))
            .mode(KernelMode::Grid3D)
