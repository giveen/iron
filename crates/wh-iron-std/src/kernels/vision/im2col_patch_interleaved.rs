...
#[kernel]
pub fn iron_im2col_patch_interleaved<T>(
    input: Tensor<T>,
    out: Tensor<T>,
...
pub mod kernel_tests {
    ...
    use super::iron_im2col_patch_interleaved;
    ...
    fn setup(
        ...
        TestSetup::new(iron_im2col_patch_interleaved::kernel_ir_for(dt))
...
pub mod kernel_benches {
    ...
    fn bench_interleaved(dt: DType) -> BenchSetup {
        ...
        let in_w = grid_w * patch;
        let n_out = grid_h * grid_w * patch_dim_padded;
        BenchSetup::new(iron_im2col_patch_interleaved::kernel_ir_for(dt))
            .mode(KernelMode::Grid3D)
