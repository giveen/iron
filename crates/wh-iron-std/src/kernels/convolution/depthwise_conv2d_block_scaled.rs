...
//! weight-quantized counterpart of `iron/depthwise_conv2d.rs`.
//!
...
//! `kernels::quant::format::dequant` oracle.
//!
//! ## DISPATCH INVARIANTS
//!
...
/// through `kernels/primitives.rs`. Produces `iron_<FMT>_depthwise_conv2d`.
#[kernel(variants(
...
pub mod kernel_tests {
    ...
    fn dw_setup(
        ...
        let p = crate::kernels::quant::format::pack(fmt, &w_f, ch, cols);
        let wdq = crate::kernels::quant::format::dequant(fmt, &p, ch, cols);
    ...
    dw_test_fmt!(
        ...
        iron_mxfp4_depthwise_conv2d::kernel_ir_for,
        QFormat::Mxfp4
    );
    dw_test_fmt!(
        test_nvfp4_depthwise_conv2d,
        iron_nvfp4_depthwise_conv2d::kernel_ir_for,
        QFormat::Nvfp4
    );
    dw_test_fmt!(test_fp4_depthwise_conv2d, iron_fp4_depthwise_conv2d::kernel_ir_for, QFormat::Fp4);
    dw_test_fmt!(
        test_mxfp8_e4m3_depthwise_conv2d,
        iron_mxfp8_e4m3_depthwise_conv2d::kernel_ir_for,
        QFormat::Mxfp8E4
    );
    dw_test_fmt!(
        test_mxfp8_e5m2_depthwise_conv2d,
        iron_mxfp8_e5m2_depthwise_conv2d::kernel_ir_for,
        QFormat::Mxfp8E5
    );
    dw_test_fmt!(
        test_fp8_e5m2_depthwise_conv2d,
        iron_fp8_e5m2_depthwise_conv2d::kernel_ir_for,
        QFormat::Fp8E5m2
    );
    dw_test_fmt!(
        test_nvfp8_depthwise_conv2d,
        iron_nvfp8_depthwise_conv2d::kernel_ir_for,
        QFormat::Nvfp8
    );
    dw_test_fmt!(
    ...
    dw_test_fmt!(
        ...
        iron_int8_depthwise_conv2d::kernel_ir_for,
        QFormat::Int8
    );
    dw_test_fmt!(
        test_int2_depthwise_conv2d,
        iron_int2_depthwise_conv2d::kernel_ir_for,
        QFormat::Int2
    );
    dw_test_fmt!(
        test_int3_depthwise_conv2d,
        iron_int3_depthwise_conv2d::kernel_ir_for,
        QFormat::Int3
    );
    dw_test_fmt!(
        test_int4_depthwise_conv2d,
        iron_int4_depthwise_conv2d::kernel_ir_for,
        QFormat::Int4
    );
    dw_test_fmt!(
        test_int5_depthwise_conv2d,
        iron_int5_depthwise_conv2d::kernel_ir_for,
        QFormat::Int5
    );
    dw_test_fmt!(
        test_int6_depthwise_conv2d,
        iron_int6_depthwise_conv2d::kernel_ir_for,
        QFormat::Int6
    );
    dw_test_fmt!(
        test_mxint2_depthwise_conv2d,
        iron_mxint2_depthwise_conv2d::kernel_ir_for,
        QFormat::Mxint2
    );
    dw_test_fmt!(
        test_mxint3_depthwise_conv2d,
        iron_mxint3_depthwise_conv2d::kernel_ir_for,
        QFormat::Mxint3
    );
    dw_test_fmt!(
        test_mxint4_depthwise_conv2d,
        iron_mxint4_depthwise_conv2d::kernel_ir_for,
        QFormat::Mxint4
    );
    dw_test_fmt!(
        test_mxint5_depthwise_conv2d,
        iron_mxint5_depthwise_conv2d::kernel_ir_for,
        QFormat::Mxint5
    );
    dw_test_fmt!(
        test_mxint6_depthwise_conv2d,
        iron_mxint6_depthwise_conv2d::kernel_ir_for,
        QFormat::Mxint6
    );
    dw_test_fmt!(
        test_mxint8_depthwise_conv2d,
        iron_mxint8_depthwise_conv2d::kernel_ir_for,
        QFormat::Mxint8
    );
    dw_test_fmt!(
        test_nvfp8_f16_depthwise_conv2d,
        iron_nvfp8_f16_depthwise_conv2d::kernel_ir_for,
        QFormat::Nvfp8F16
    );
    dw_test_fmt!(
    ...
    dw_test_fmt!(
        ...
        iron_fp4_f16_depthwise_conv2d::kernel_ir_for,
        QFormat::Fp4F16
    );
    dw_test_fmt!(
        test_fp8_e5m2_f16_depthwise_conv2d,
        iron_fp8_e5m2_f16_depthwise_conv2d::kernel_ir_for,
        QFormat::Fp8E5m2F16
    );
    dw_test_fmt!(
        test_int2_f16_depthwise_conv2d,
        iron_int2_f16_depthwise_conv2d::kernel_ir_for,
        QFormat::Int2F16
    );
    dw_test_fmt!(
        test_int3_f16_depthwise_conv2d,
        iron_int3_f16_depthwise_conv2d::kernel_ir_for,
        QFormat::Int3F16
    );
    dw_test_fmt!(
        test_int4_f16_depthwise_conv2d,
        iron_int4_f16_depthwise_conv2d::kernel_ir_for,
        QFormat::Int4F16
    );
    dw_test_fmt!(
        test_int5_f16_depthwise_conv2d,
        iron_int5_f16_depthwise_conv2d::kernel_ir_for,
        QFormat::Int5F16
    );
    dw_test_fmt!(
        test_int6_f16_depthwise_conv2d,
        iron_int6_f16_depthwise_conv2d::kernel_ir_for,
        QFormat::Int6F16
    );
    dw_test_fmt!(
        test_int8_f16_depthwise_conv2d,
        iron_int8_f16_depthwise_conv2d::kernel_ir_for,
        QFormat::Int8F16
    );
}
...
pub mod kernel_benches {
    ...
    fn dw_bench(
        ...
        let (codes_len, codes_dt) = if fmt.element_bits() == 8 {
            ...
            (
                crate::kernels::quant::format::bitstream_words(ch * cols, fmt.element_bits()),
                DType::U32,
            )
        };
        let scales_dt = match fmt.scale_kind() {
    ...
    dw_bench_fmt!(bench_mxfp4, iron_mxfp4_depthwise_conv2d::kernel_ir_for, QFormat::Mxfp4);
    dw_bench_fmt!(bench_nvfp4, iron_nvfp4_depthwise_conv2d::kernel_ir_for, QFormat::Nvfp4);
    dw_bench_fmt!(bench_fp4, iron_fp4_depthwise_conv2d::kernel_ir_for, QFormat::Fp4);
    dw_bench_fmt!(
        bench_mxfp8_e4m3,
        iron_mxfp8_e4m3_depthwise_conv2d::kernel_ir_for,
        QFormat::Mxfp8E4
    ...
    dw_bench_fmt!(bench_fp8_e5m2, iron_fp8_e5m2_depthwise_conv2d::kernel_ir_for, QFormat::Fp8E5m2);
    dw_bench_fmt!(bench_nvfp8, iron_nvfp8_depthwise_conv2d::kernel_ir_for, QFormat::Nvfp8);
    dw_bench_fmt!(bench_int8, iron_int8_depthwise_conv2d::kernel_ir_for, QFormat::Int8);
    // Symmetric sub-byte ints (int2-6, FP32 group scale) + MXINT (mxint2-6, E8M0
    // block scale) + MXINT8 (8-bit, E8M0).
    dw_bench_fmt!(bench_int2, iron_int2_depthwise_conv2d::kernel_ir_for, QFormat::Int2);
    dw_bench_fmt!(bench_int3, iron_int3_depthwise_conv2d::kernel_ir_for, QFormat::Int3);
    dw_bench_fmt!(bench_int4, iron_int4_depthwise_conv2d::kernel_ir_for, QFormat::Int4);
    dw_bench_fmt!(bench_int5, iron_int5_depthwise_conv2d::kernel_ir_for, QFormat::Int5);
    dw_bench_fmt!(bench_int6, iron_int6_depthwise_conv2d::kernel_ir_for, QFormat::Int6);
    dw_bench_fmt!(bench_mxint2, iron_mxint2_depthwise_conv2d::kernel_ir_for, QFormat::Mxint2);
    dw_bench_fmt!(bench_mxint3, iron_mxint3_depthwise_conv2d::kernel_ir_for, QFormat::Mxint3);
    dw_bench_fmt!(bench_mxint4, iron_mxint4_depthwise_conv2d::kernel_ir_for, QFormat::Mxint4);
    dw_bench_fmt!(bench_mxint5, iron_mxint5_depthwise_conv2d::kernel_ir_for, QFormat::Mxint5);
    dw_bench_fmt!(bench_mxint6, iron_mxint6_depthwise_conv2d::kernel_ir_for, QFormat::Mxint6);
    dw_bench_fmt!(bench_mxint8, iron_mxint8_depthwise_conv2d::kernel_ir_for, QFormat::Mxint8);
    ...
    dw_bench_fmt!(bench_fp4_f16, iron_fp4_f16_depthwise_conv2d::kernel_ir_for, QFormat::Fp4F16);
    dw_bench_fmt!(
        bench_fp8_e5m2_f16,
        iron_fp8_e5m2_f16_depthwise_conv2d::kernel_ir_for,
        QFormat::Fp8E5m2F16
    );
    dw_bench_fmt!(bench_int2_f16, iron_int2_f16_depthwise_conv2d::kernel_ir_for, QFormat::Int2F16);
    dw_bench_fmt!(bench_int3_f16, iron_int3_f16_depthwise_conv2d::kernel_ir_for, QFormat::Int3F16);
    dw_bench_fmt!(bench_int4_f16, iron_int4_f16_depthwise_conv2d::kernel_ir_for, QFormat::Int4F16);
    dw_bench_fmt!(bench_int5_f16, iron_int5_f16_depthwise_conv2d::kernel_ir_for, QFormat::Int5F16);
    dw_bench_fmt!(bench_int6_f16, iron_int6_f16_depthwise_conv2d::kernel_ir_for, QFormat::Int6F16);
    dw_bench_fmt!(bench_int8_f16, iron_int8_f16_depthwise_conv2d::kernel_ir_for, QFormat::Int8F16);
}
