...
/// `kernels/primitives.rs`. Produces `iron_<FMT>_conv2d`.
#[kernel(variants(
...
pub mod kernel_tests {
    ...
    conv2d_test_fmt!(test_mxfp4_conv2d, iron_mxfp4_conv2d::kernel_ir_for, QFormat::Mxfp4);
    conv2d_test_fmt!(test_nvfp4_conv2d, iron_nvfp4_conv2d::kernel_ir_for, QFormat::Nvfp4);
    conv2d_test_fmt!(test_fp4_conv2d, iron_fp4_conv2d::kernel_ir_for, QFormat::Fp4);
    conv2d_test_fmt!(
        test_mxfp8_e4m3_conv2d,
        iron_mxfp8_e4m3_conv2d::kernel_ir_for,
        QFormat::Mxfp8E4
    );
    conv2d_test_fmt!(
        test_mxfp8_e5m2_conv2d,
        iron_mxfp8_e5m2_conv2d::kernel_ir_for,
        QFormat::Mxfp8E5
    );
    conv2d_test_fmt!(test_fp8_e5m2_conv2d, iron_fp8_e5m2_conv2d::kernel_ir_for, QFormat::Fp8E5m2);
    conv2d_test_fmt!(test_nvfp8_conv2d, iron_nvfp8_conv2d::kernel_ir_for, QFormat::Nvfp8);
    conv2d_test_fmt!(test_fp8_e4m3_conv2d, iron_nvfp8_conv2d::kernel_ir_for, QFormat::Fp8E4m3);
    conv2d_test_fmt!(test_int8_conv2d, iron_int8_conv2d::kernel_ir_for, QFormat::Int8);
    conv2d_test_fmt!(test_int2_conv2d, iron_int2_conv2d::kernel_ir_for, QFormat::Int2);
    conv2d_test_fmt!(test_int3_conv2d, iron_int3_conv2d::kernel_ir_for, QFormat::Int3);
    conv2d_test_fmt!(test_int4_conv2d, iron_int4_conv2d::kernel_ir_for, QFormat::Int4);
    conv2d_test_fmt!(test_int5_conv2d, iron_int5_conv2d::kernel_ir_for, QFormat::Int5);
    conv2d_test_fmt!(test_int6_conv2d, iron_int6_conv2d::kernel_ir_for, QFormat::Int6);
    conv2d_test_fmt!(test_mxint2_conv2d, iron_mxint2_conv2d::kernel_ir_for, QFormat::Mxint2);
    conv2d_test_fmt!(test_mxint3_conv2d, iron_mxint3_conv2d::kernel_ir_for, QFormat::Mxint3);
    conv2d_test_fmt!(test_mxint4_conv2d, iron_mxint4_conv2d::kernel_ir_for, QFormat::Mxint4);
    conv2d_test_fmt!(test_mxint5_conv2d, iron_mxint5_conv2d::kernel_ir_for, QFormat::Mxint5);
    conv2d_test_fmt!(test_mxint6_conv2d, iron_mxint6_conv2d::kernel_ir_for, QFormat::Mxint6);
    conv2d_test_fmt!(test_mxint8_conv2d, iron_mxint8_conv2d::kernel_ir_for, QFormat::Mxint8);
    conv2d_test_fmt!(
        test_nvfp8_f16_conv2d,
        iron_nvfp8_f16_conv2d::kernel_ir_for,
        QFormat::Nvfp8F16
    );
    conv2d_test_fmt!(
    ...
    conv2d_test_fmt!(test_fp4_f16_conv2d, iron_fp4_f16_conv2d::kernel_ir_for, QFormat::Fp4F16);
    conv2d_test_fmt!(
        test_fp8_e5m2_f16_conv2d,
        iron_fp8_e5m2_f16_conv2d::kernel_ir_for,
        QFormat::Fp8E5m2F16
    );
    conv2d_test_fmt!(test_int2_f16_conv2d, iron_int2_f16_conv2d::kernel_ir_for, QFormat::Int2F16);
    conv2d_test_fmt!(test_int3_f16_conv2d, iron_int3_f16_conv2d::kernel_ir_for, QFormat::Int3F16);
    conv2d_test_fmt!(test_int4_f16_conv2d, iron_int4_f16_conv2d::kernel_ir_for, QFormat::Int4F16);
    conv2d_test_fmt!(test_int5_f16_conv2d, iron_int5_f16_conv2d::kernel_ir_for, QFormat::Int5F16);
    conv2d_test_fmt!(test_int6_f16_conv2d, iron_int6_f16_conv2d::kernel_ir_for, QFormat::Int6F16);
    conv2d_test_fmt!(test_int8_f16_conv2d, iron_int8_f16_conv2d::kernel_ir_for, QFormat::Int8F16);
}
...
pub mod kernel_benches {
    ...
    conv2d_bench_fmt!(bench_mxfp4, iron_mxfp4_conv2d::kernel_ir_for, QFormat::Mxfp4);
    conv2d_bench_fmt!(bench_nvfp4, iron_nvfp4_conv2d::kernel_ir_for, QFormat::Nvfp4);
    conv2d_bench_fmt!(bench_fp4, iron_fp4_conv2d::kernel_ir_for, QFormat::Fp4);
    conv2d_bench_fmt!(bench_mxfp8_e4m3, iron_mxfp8_e4m3_conv2d::kernel_ir_for, QFormat::Mxfp8E4);
    conv2d_bench_fmt!(bench_mxfp8_e5m2, iron_mxfp8_e5m2_conv2d::kernel_ir_for, QFormat::Mxfp8E5);
    conv2d_bench_fmt!(bench_fp8_e5m2, iron_fp8_e5m2_conv2d::kernel_ir_for, QFormat::Fp8E5m2);
    conv2d_bench_fmt!(bench_nvfp8, iron_nvfp8_conv2d::kernel_ir_for, QFormat::Nvfp8);
    conv2d_bench_fmt!(bench_int8, iron_int8_conv2d::kernel_ir_for, QFormat::Int8);
    // Symmetric sub-byte ints (FP32 group scale) + MXINT (E8M0 block scale) +
    // MXINT8 (8-bit, E8M0). C=1024 is a multiple of 32, so every filter row's
    // bit-stream is word-aligned for all widths.
    conv2d_bench_fmt!(bench_int2, iron_int2_conv2d::kernel_ir_for, QFormat::Int2);
    conv2d_bench_fmt!(bench_int3, iron_int3_conv2d::kernel_ir_for, QFormat::Int3);
    conv2d_bench_fmt!(bench_int4, iron_int4_conv2d::kernel_ir_for, QFormat::Int4);
    conv2d_bench_fmt!(bench_int5, iron_int5_conv2d::kernel_ir_for, QFormat::Int5);
    conv2d_bench_fmt!(bench_int6, iron_int6_conv2d::kernel_ir_for, QFormat::Int6);
    conv2d_bench_fmt!(bench_mxint2, iron_mxint2_conv2d::kernel_ir_for, QFormat::Mxint2);
    conv2d_bench_fmt!(bench_mxint3, iron_mxint3_conv2d::kernel_ir_for, QFormat::Mxint3);
    conv2d_bench_fmt!(bench_mxint4, iron_mxint4_conv2d::kernel_ir_for, QFormat::Mxint4);
    conv2d_bench_fmt!(bench_mxint5, iron_mxint5_conv2d::kernel_ir_for, QFormat::Mxint5);
    conv2d_bench_fmt!(bench_mxint6, iron_mxint6_conv2d::kernel_ir_for, QFormat::Mxint6);
    conv2d_bench_fmt!(bench_mxint8, iron_mxint8_conv2d::kernel_ir_for, QFormat::Mxint8);
    ...
    conv2d_bench_fmt!(bench_nvfp8_f16, iron_nvfp8_f16_conv2d::kernel_ir_for, QFormat::Nvfp8F16);
    conv2d_bench_fmt!(
        bench_fp8_e4m3_f16,
        iron_nvfp8_f16_conv2d::kernel_ir_for,
        QFormat::Fp8E4m3F16
    );
    conv2d_bench_fmt!(bench_fp4_f16, iron_fp4_f16_conv2d::kernel_ir_for, QFormat::Fp4F16);
    conv2d_bench_fmt!(
        bench_fp8_e5m2_f16,
        iron_fp8_e5m2_f16_conv2d::kernel_ir_for,
        QFormat::Fp8E5m2F16
    );
    conv2d_bench_fmt!(bench_int2_f16, iron_int2_f16_conv2d::kernel_ir_for, QFormat::Int2F16);
    conv2d_bench_fmt!(bench_int3_f16, iron_int3_f16_conv2d::kernel_ir_for, QFormat::Int3F16);
    conv2d_bench_fmt!(bench_int4_f16, iron_int4_f16_conv2d::kernel_ir_for, QFormat::Int4F16);
    conv2d_bench_fmt!(bench_int5_f16, iron_int5_f16_conv2d::kernel_ir_for, QFormat::Int5F16);
    conv2d_bench_fmt!(bench_int6_f16, iron_int6_f16_conv2d::kernel_ir_for, QFormat::Int6F16);
    conv2d_bench_fmt!(bench_int8_f16, iron_int8_f16_conv2d::kernel_ir_for, QFormat::Int8F16);
}
