...
//! templates:
//!
//! - `iron/conv2d_mma.rs` (dense cooperative conv2d) supplies the **entire
...
/// through `kernels/primitives.rs`. Produces `iron_<FMT>_conv2d_mma`.
#[kernel(variants(
    ...
    for kb in range(0u32, total_k, 32u32) {
        ...
        for i in range(0u32, 8u32, 1u32) {
            ...
            let elem = if WDEC == 0u32 {
                ...
                iron_decode_e2m1((pack >> ((kt_safe & 7u32) * 4u32)) & 0xFu32)
            } else if WDEC == 1u32 {
...
pub mod kernel_tests {
    ...
    fn test_mxfp4_conv2d_mma(dt: DType) -> TestSetup {
        mma_setup(
            iron_mxfp4_conv2d_mma::kernel_ir_for(dt),
            QFormat::Mxfp4,
            2,
            4,
            7,
    ...
    fn test_nvfp4_conv2d_mma(dt: DType) -> TestSetup {
        mma_setup(
            iron_nvfp4_conv2d_mma::kernel_ir_for(dt),
            QFormat::Nvfp4,
            2,
            4,
            7,
    ...
    fn test_fp4_conv2d_mma(dt: DType) -> TestSetup {
        mma_setup(iron_fp4_conv2d_mma::kernel_ir_for(dt), QFormat::Fp4, 2, 4, 7, 7, 32, 4, 4, dt)
    }

    #[test_kernel(dtypes = [f32, f16, bf16], tol = [5e-3, 5e-2, 2e-1])]
    fn test_mxfp8_e4m3_conv2d_mma(dt: DType) -> TestSetup {
        mma_setup(
            iron_mxfp8_e4m3_conv2d_mma::kernel_ir_for(dt),
            QFormat::Mxfp8E4,
            2,
            4,
            7,
    ...
    fn test_mxfp8_e5m2_conv2d_mma(dt: DType) -> TestSetup {
        mma_setup(
            iron_mxfp8_e5m2_conv2d_mma::kernel_ir_for(dt),
            QFormat::Mxfp8E5,
            2,
            4,
            7,
    ...
    fn test_nvfp8_conv2d_mma(dt: DType) -> TestSetup {
        mma_setup(
            iron_nvfp8_conv2d_mma::kernel_ir_for(dt),
            QFormat::Nvfp8,
            2,
            4,
            7,
    ...
    fn test_fp8_e5m2_conv2d_mma(dt: DType) -> TestSetup {
        mma_setup(
            iron_fp8_e5m2_conv2d_mma::kernel_ir_for(dt),
            QFormat::Fp8E5m2,
            2,
            4,
            7,
    ...
    fn test_int8_conv2d_mma(dt: DType) -> TestSetup {
        mma_setup(iron_int8_conv2d_mma::kernel_ir_for(dt), QFormat::Int8, 2, 4, 7, 7, 32, 4, 4, dt)
    }

    // ── Symmetric integer formats (FP32 group scale, group 64) ──
    #[test_kernel(dtypes = [f32, f16, bf16], tol = [5e-3, 5e-2, 2e-1])]
    fn test_int2_conv2d_mma(dt: DType) -> TestSetup {
        mma_setup(iron_int2_conv2d_mma::kernel_ir_for(dt), QFormat::Int2, 2, 4, 7, 7, 32, 4, 4, dt)
    }

    #[test_kernel(dtypes = [f32, f16, bf16], tol = [5e-3, 5e-2, 2e-1])]
    fn test_int3_conv2d_mma(dt: DType) -> TestSetup {
        mma_setup(iron_int3_conv2d_mma::kernel_ir_for(dt), QFormat::Int3, 2, 4, 7, 7, 32, 4, 4, dt)
    }

    #[test_kernel(dtypes = [f32, f16, bf16], tol = [5e-3, 5e-2, 2e-1])]
    fn test_int4_conv2d_mma(dt: DType) -> TestSetup {
        mma_setup(iron_int4_conv2d_mma::kernel_ir_for(dt), QFormat::Int4, 2, 4, 7, 7, 32, 4, 4, dt)
    }

    #[test_kernel(dtypes = [f32, f16, bf16], tol = [5e-3, 5e-2, 2e-1])]
    fn test_int5_conv2d_mma(dt: DType) -> TestSetup {
        mma_setup(iron_int5_conv2d_mma::kernel_ir_for(dt), QFormat::Int5, 2, 4, 7, 7, 32, 4, 4, dt)
    }

    #[test_kernel(dtypes = [f32, f16, bf16], tol = [5e-3, 5e-2, 2e-1])]
    fn test_int6_conv2d_mma(dt: DType) -> TestSetup {
        mma_setup(iron_int6_conv2d_mma::kernel_ir_for(dt), QFormat::Int6, 2, 4, 7, 7, 32, 4, 4, dt)
    }
    ...
    fn test_mxint2_conv2d_mma(dt: DType) -> TestSetup {
        mma_setup(
            iron_mxint2_conv2d_mma::kernel_ir_for(dt),
            QFormat::Mxint2,
            2,
            4,
            7,
    ...
    fn test_mxint3_conv2d_mma(dt: DType) -> TestSetup {
        mma_setup(
            iron_mxint3_conv2d_mma::kernel_ir_for(dt),
            QFormat::Mxint3,
            2,
            4,
            7,
    ...
    fn test_mxint4_conv2d_mma(dt: DType) -> TestSetup {
        mma_setup(
            iron_mxint4_conv2d_mma::kernel_ir_for(dt),
            QFormat::Mxint4,
            2,
            4,
            7,
    ...
    fn test_mxint5_conv2d_mma(dt: DType) -> TestSetup {
        mma_setup(
            iron_mxint5_conv2d_mma::kernel_ir_for(dt),
            QFormat::Mxint5,
            2,
            4,
            7,
    ...
    fn test_mxint6_conv2d_mma(dt: DType) -> TestSetup {
        mma_setup(
            iron_mxint6_conv2d_mma::kernel_ir_for(dt),
            QFormat::Mxint6,
            2,
            4,
            7,
    ...
    fn test_mxint8_conv2d_mma(dt: DType) -> TestSetup {
        mma_setup(
            iron_mxint8_conv2d_mma::kernel_ir_for(dt),
            QFormat::Mxint8,
            2,
            4,
            7,
    ...
    fn test_nvfp8_f16_conv2d_mma(dt: DType) -> TestSetup {
        mma_setup(
            iron_nvfp8_f16_conv2d_mma::kernel_ir_for(dt),
            QFormat::Nvfp8F16,
            2,
            4,
            7,
    ...
    fn test_fp4_f16_conv2d_mma(dt: DType) -> TestSetup {
        mma_setup(
            iron_fp4_f16_conv2d_mma::kernel_ir_for(dt),
            QFormat::Fp4F16,
            2,
            4,
            7,
    ...
    fn test_fp8_e5m2_f16_conv2d_mma(dt: DType) -> TestSetup {
        mma_setup(
            iron_fp8_e5m2_f16_conv2d_mma::kernel_ir_for(dt),
            QFormat::Fp8E5m2F16,
            2,
            4,
            7,
    ...
    fn test_int2_f16_conv2d_mma(dt: DType) -> TestSetup {
        mma_setup(
            iron_int2_f16_conv2d_mma::kernel_ir_for(dt),
            QFormat::Int2F16,
            2,
            4,
            7,
    ...
    fn test_int3_f16_conv2d_mma(dt: DType) -> TestSetup {
        mma_setup(
            iron_int3_f16_conv2d_mma::kernel_ir_for(dt),
            QFormat::Int3F16,
            2,
            4,
            7,
    ...
    fn test_int4_f16_conv2d_mma(dt: DType) -> TestSetup {
        mma_setup(
            iron_int4_f16_conv2d_mma::kernel_ir_for(dt),
            QFormat::Int4F16,
            2,
            4,
            7,
    ...
    fn test_int5_f16_conv2d_mma(dt: DType) -> TestSetup {
        mma_setup(
            iron_int5_f16_conv2d_mma::kernel_ir_for(dt),
            QFormat::Int5F16,
            2,
            4,
            7,
    ...
    fn test_int6_f16_conv2d_mma(dt: DType) -> TestSetup {
        mma_setup(
            iron_int6_f16_conv2d_mma::kernel_ir_for(dt),
            QFormat::Int6F16,
            2,
            4,
            7,
    ...
    fn test_int8_f16_conv2d_mma(dt: DType) -> TestSetup {
        mma_setup(
            iron_int8_f16_conv2d_mma::kernel_ir_for(dt),
            QFormat::Int8F16,
            2,
            4,
            7,
...
pub mod kernel_benches {
    ...
    conv2d_mma_bench_fmt!(bench_mxfp4, iron_mxfp4_conv2d_mma::kernel_ir_for, QFormat::Mxfp4);
    conv2d_mma_bench_fmt!(bench_nvfp4, iron_nvfp4_conv2d_mma::kernel_ir_for, QFormat::Nvfp4);
    conv2d_mma_bench_fmt!(bench_fp4, iron_fp4_conv2d_mma::kernel_ir_for, QFormat::Fp4);
    conv2d_mma_bench_fmt!(
        bench_mxfp8_e4m3,
        iron_mxfp8_e4m3_conv2d_mma::kernel_ir_for,
        QFormat::Mxfp8E4
    );
    conv2d_mma_bench_fmt!(
        bench_mxfp8_e5m2,
        iron_mxfp8_e5m2_conv2d_mma::kernel_ir_for,
        QFormat::Mxfp8E5
    );
    conv2d_mma_bench_fmt!(bench_nvfp8, iron_nvfp8_conv2d_mma::kernel_ir_for, QFormat::Nvfp8);
    conv2d_mma_bench_fmt!(
        bench_fp8_e5m2,
        iron_fp8_e5m2_conv2d_mma::kernel_ir_for,
        QFormat::Fp8E5m2
    );
    conv2d_mma_bench_fmt!(bench_int8, iron_int8_conv2d_mma::kernel_ir_for, QFormat::Int8);
    conv2d_mma_bench_fmt!(bench_int2, iron_int2_conv2d_mma::kernel_ir_for, QFormat::Int2);
    conv2d_mma_bench_fmt!(bench_int3, iron_int3_conv2d_mma::kernel_ir_for, QFormat::Int3);
    conv2d_mma_bench_fmt!(bench_int4, iron_int4_conv2d_mma::kernel_ir_for, QFormat::Int4);
    conv2d_mma_bench_fmt!(bench_int5, iron_int5_conv2d_mma::kernel_ir_for, QFormat::Int5);
    conv2d_mma_bench_fmt!(bench_int6, iron_int6_conv2d_mma::kernel_ir_for, QFormat::Int6);
    conv2d_mma_bench_fmt!(bench_mxint2, iron_mxint2_conv2d_mma::kernel_ir_for, QFormat::Mxint2);
    conv2d_mma_bench_fmt!(bench_mxint3, iron_mxint3_conv2d_mma::kernel_ir_for, QFormat::Mxint3);
    conv2d_mma_bench_fmt!(bench_mxint4, iron_mxint4_conv2d_mma::kernel_ir_for, QFormat::Mxint4);
    conv2d_mma_bench_fmt!(bench_mxint5, iron_mxint5_conv2d_mma::kernel_ir_for, QFormat::Mxint5);
    conv2d_mma_bench_fmt!(bench_mxint6, iron_mxint6_conv2d_mma::kernel_ir_for, QFormat::Mxint6);
    conv2d_mma_bench_fmt!(bench_mxint8, iron_mxint8_conv2d_mma::kernel_ir_for, QFormat::Mxint8);
    conv2d_mma_bench_fmt!(
        bench_nvfp8_f16,
        iron_nvfp8_f16_conv2d_mma::kernel_ir_for,
        QFormat::Nvfp8F16
    );
    conv2d_mma_bench_fmt!(
        bench_fp8_e4m3_f16,
    ...
    conv2d_mma_bench_fmt!(bench_fp4_f16, iron_fp4_f16_conv2d_mma::kernel_ir_for, QFormat::Fp4F16);
    conv2d_mma_bench_fmt!(
        bench_fp8_e5m2_f16,
        iron_fp8_e5m2_f16_conv2d_mma::kernel_ir_for,
        QFormat::Fp8E5m2F16
    );
    conv2d_mma_bench_fmt!(
        bench_int2_f16,
        iron_int2_f16_conv2d_mma::kernel_ir_for,
        QFormat::Int2F16
    );
    conv2d_mma_bench_fmt!(
        bench_int3_f16,
        iron_int3_f16_conv2d_mma::kernel_ir_for,
        QFormat::Int3F16
    );
    conv2d_mma_bench_fmt!(
        bench_int4_f16,
        iron_int4_f16_conv2d_mma::kernel_ir_for,
        QFormat::Int4F16
    );
    conv2d_mma_bench_fmt!(
        bench_int5_f16,
        iron_int5_f16_conv2d_mma::kernel_ir_for,
        QFormat::Int5F16
    );
    conv2d_mma_bench_fmt!(
        bench_int6_f16,
        iron_int6_f16_conv2d_mma::kernel_ir_for,
        QFormat::Int6F16
    );
    conv2d_mma_bench_fmt!(
        bench_int8_f16,
        iron_int8_f16_conv2d_mma::kernel_ir_for,
        QFormat::Int8F16
    );
}
