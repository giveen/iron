...
//! simdgroup-matrix counterpart of `iron/conv3d_mma.rs`, with a quantized
//! filter. It is the 3D analogue of `mlx/block_scaled_mma.rs` and the
//! MMA-throughput sibling of `iron/conv3d_block_scaled.rs`.
//!
...
pub mod kernel_tests {
    ...
    conv3d_mma_test_fmt!(
        ...
        iron_mxfp4_conv3d_mma::kernel_ir_for,
        QFormat::Mxfp4
    );
    conv3d_mma_test_fmt!(
        test_nvfp4_conv3d_mma,
        iron_nvfp4_conv3d_mma::kernel_ir_for,
        QFormat::Nvfp4
    );
    conv3d_mma_test_fmt!(test_fp4_conv3d_mma, iron_fp4_conv3d_mma::kernel_ir_for, QFormat::Fp4);
    conv3d_mma_test_fmt!(
        test_mxfp8_e4m3_conv3d_mma,
        iron_mxfp8_e4m3_conv3d_mma::kernel_ir_for,
        QFormat::Mxfp8E4
    );
    conv3d_mma_test_fmt!(
        test_mxfp8_e5m2_conv3d_mma,
        iron_mxfp8_e5m2_conv3d_mma::kernel_ir_for,
        QFormat::Mxfp8E5
    );
    conv3d_mma_test_fmt!(
        test_fp8_e5m2_conv3d_mma,
        iron_fp8_e5m2_conv3d_mma::kernel_ir_for,
        QFormat::Fp8E5m2
    );
    conv3d_mma_test_fmt!(
        test_nvfp8_conv3d_mma,
        iron_nvfp8_conv3d_mma::kernel_ir_for,
        QFormat::Nvfp8
    );
    conv3d_mma_test_fmt!(
    ...
    conv3d_mma_test_fmt!(test_int8_conv3d_mma, iron_int8_conv3d_mma::kernel_ir_for, QFormat::Int8);
    conv3d_mma_test_fmt!(test_int2_conv3d_mma, iron_int2_conv3d_mma::kernel_ir_for, QFormat::Int2);
    conv3d_mma_test_fmt!(test_int3_conv3d_mma, iron_int3_conv3d_mma::kernel_ir_for, QFormat::Int3);
    conv3d_mma_test_fmt!(test_int4_conv3d_mma, iron_int4_conv3d_mma::kernel_ir_for, QFormat::Int4);
    conv3d_mma_test_fmt!(test_int5_conv3d_mma, iron_int5_conv3d_mma::kernel_ir_for, QFormat::Int5);
    conv3d_mma_test_fmt!(test_int6_conv3d_mma, iron_int6_conv3d_mma::kernel_ir_for, QFormat::Int6);
    conv3d_mma_test_fmt!(
        test_mxint2_conv3d_mma,
        iron_mxint2_conv3d_mma::kernel_ir_for,
        QFormat::Mxint2
    );
    conv3d_mma_test_fmt!(
        test_mxint3_conv3d_mma,
        iron_mxint3_conv3d_mma::kernel_ir_for,
        QFormat::Mxint3
    );
    conv3d_mma_test_fmt!(
        test_mxint4_conv3d_mma,
        iron_mxint4_conv3d_mma::kernel_ir_for,
        QFormat::Mxint4
    );
    conv3d_mma_test_fmt!(
        test_mxint5_conv3d_mma,
        iron_mxint5_conv3d_mma::kernel_ir_for,
        QFormat::Mxint5
    );
    conv3d_mma_test_fmt!(
        test_mxint6_conv3d_mma,
        iron_mxint6_conv3d_mma::kernel_ir_for,
        QFormat::Mxint6
    );
    conv3d_mma_test_fmt!(
        test_mxint8_conv3d_mma,
        iron_mxint8_conv3d_mma::kernel_ir_for,
        QFormat::Mxint8
    );
    conv3d_mma_test_fmt!(
        test_nvfp8_f16_conv3d_mma,
        iron_nvfp8_f16_conv3d_mma::kernel_ir_for,
        QFormat::Nvfp8F16
    );
    conv3d_mma_test_fmt!(
    ...
    conv3d_mma_test_fmt!(
        ...
        iron_fp4_f16_conv3d_mma::kernel_ir_for,
        QFormat::Fp4F16
    );
    conv3d_mma_test_fmt!(
        test_fp8_e5m2_f16_conv3d_mma,
        iron_fp8_e5m2_f16_conv3d_mma::kernel_ir_for,
        QFormat::Fp8E5m2F16
    );
    conv3d_mma_test_fmt!(
        test_int2_f16_conv3d_mma,
        iron_int2_f16_conv3d_mma::kernel_ir_for,
        QFormat::Int2F16
    );
    conv3d_mma_test_fmt!(
        test_int3_f16_conv3d_mma,
        iron_int3_f16_conv3d_mma::kernel_ir_for,
        QFormat::Int3F16
    );
    conv3d_mma_test_fmt!(
        test_int4_f16_conv3d_mma,
        iron_int4_f16_conv3d_mma::kernel_ir_for,
        QFormat::Int4F16
    );
    conv3d_mma_test_fmt!(
        test_int5_f16_conv3d_mma,
        iron_int5_f16_conv3d_mma::kernel_ir_for,
        QFormat::Int5F16
    );
    conv3d_mma_test_fmt!(
        test_int6_f16_conv3d_mma,
        iron_int6_f16_conv3d_mma::kernel_ir_for,
        QFormat::Int6F16
    );
    conv3d_mma_test_fmt!(
        test_int8_f16_conv3d_mma,
        iron_int8_f16_conv3d_mma::kernel_ir_for,
        QFormat::Int8F16
    );
}
...
pub mod kernel_benches {
    ...
    conv3d_mma_bench_fmt!(bench_mxfp4, iron_mxfp4_conv3d_mma::kernel_ir_for, QFormat::Mxfp4);
    conv3d_mma_bench_fmt!(bench_nvfp4, iron_nvfp4_conv3d_mma::kernel_ir_for, QFormat::Nvfp4);
    ...
    conv3d_mma_bench_fmt!(bench_nvfp8, iron_nvfp8_conv3d_mma::kernel_ir_for, QFormat::Nvfp8);
    conv3d_mma_bench_fmt!(bench_fp4, iron_fp4_conv3d_mma::kernel_ir_for, QFormat::Fp4);
    conv3d_mma_bench_fmt!(
        bench_fp8_e5m2,
        iron_fp8_e5m2_conv3d_mma::kernel_ir_for,
        QFormat::Fp8E5m2
    );
    conv3d_mma_bench_fmt!(bench_int8, iron_int8_conv3d_mma::kernel_ir_for, QFormat::Int8);
    conv3d_mma_bench_fmt!(bench_int2, iron_int2_conv3d_mma::kernel_ir_for, QFormat::Int2);
    conv3d_mma_bench_fmt!(bench_int3, iron_int3_conv3d_mma::kernel_ir_for, QFormat::Int3);
    conv3d_mma_bench_fmt!(bench_int4, iron_int4_conv3d_mma::kernel_ir_for, QFormat::Int4);
    conv3d_mma_bench_fmt!(bench_int5, iron_int5_conv3d_mma::kernel_ir_for, QFormat::Int5);
    conv3d_mma_bench_fmt!(bench_int6, iron_int6_conv3d_mma::kernel_ir_for, QFormat::Int6);
    conv3d_mma_bench_fmt!(bench_mxint2, iron_mxint2_conv3d_mma::kernel_ir_for, QFormat::Mxint2);
    conv3d_mma_bench_fmt!(bench_mxint3, iron_mxint3_conv3d_mma::kernel_ir_for, QFormat::Mxint3);
    conv3d_mma_bench_fmt!(bench_mxint4, iron_mxint4_conv3d_mma::kernel_ir_for, QFormat::Mxint4);
    conv3d_mma_bench_fmt!(bench_mxint5, iron_mxint5_conv3d_mma::kernel_ir_for, QFormat::Mxint5);
    conv3d_mma_bench_fmt!(bench_mxint6, iron_mxint6_conv3d_mma::kernel_ir_for, QFormat::Mxint6);
    conv3d_mma_bench_fmt!(bench_mxint8, iron_mxint8_conv3d_mma::kernel_ir_for, QFormat::Mxint8);
    ...
    conv3d_mma_bench_fmt!(bench_fp4_f16, iron_fp4_f16_conv3d_mma::kernel_ir_for, QFormat::Fp4F16);
    conv3d_mma_bench_fmt!(
        bench_fp8_e5m2_f16,
        iron_fp8_e5m2_f16_conv3d_mma::kernel_ir_for,
        QFormat::Fp8E5m2F16
