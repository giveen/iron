...
//!
//! - `iron_conv1d_causal_step` — one thread per channel, streaming decode:
...
//! - `iron_conv1d_causal_prefill` — all S prompt tokens in one dispatch from zero
...
#[kernel]
pub fn iron_conv1d_causal_step<T>(
    x: Tensor<T>,
    w: Tensor<T>,
    b: Tensor<T>,
    mut state: Tensor<T>,
...
#[kernel]
pub fn iron_conv1d_causal_prefill(
...
pub mod kernel_tests {
    ...
    use super::{iron_conv1d_causal_prefill, iron_conv1d_causal_step};
    ...
    fn conv1d_setup(n_channels: usize, kernel_size: usize, dt: DType) -> TestSetup {
        ...
        TestSetup::new(iron_conv1d_causal_step::kernel_ir_for(dt))
    ...
    fn conv1d_causal_prefill_setup(s: usize, conv_dim: usize, kc: usize) -> TestSetup {
        ...
        TestSetup::new(iron_conv1d_causal_prefill::kernel_ir_for())
            .mode(KernelMode::Grid3D)
...
pub mod kernel_benches {
    ...
    use super::iron_conv1d_causal_step;
    ...
    fn bench_conv1d_causal_step(dt: DType) -> BenchSetup {
        ...
        BenchSetup::new(iron_conv1d_causal_step::kernel_ir_for(dt))
            .mode(KernelMode::Grid3D)
