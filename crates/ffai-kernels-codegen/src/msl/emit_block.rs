            ...
            match op {
                ...
                Op::CoopTileSetup {
                    ...
                    let acc_mode_s = match acc_mode {
                        ffai_kernels_core::ir::CoopTileAccMode::Overwrite => "mode::multiply",
                        ffai_kernels_core::ir::CoopTileAccMode::MultiplyAccumulate =>
                ...
                Op::Atomic { op: ak, scope, dst, index, value } => {
                    ...
                    let rv = self.vname(Some(*value), block, extra_names);
                    match scope {
                        ffai_kernels_core::ir::AtomicScope::Device => {
                            wl!(
                                out,
                        ...
                        ffai_kernels_core::ir::AtomicScope::Threadgroup => {
