...
use ffai_kernels_core::ir::{BinOpKind, Block, BlockId, Kernel, Op, UnaryOpKind, ValueId};
...
#[cfg(test)]
mod tests {
    use ffai_kernels_core::ir::{BinOpKind, VarId};
    ...
    fn fold_in_block(
        ...
        ops.push(ffai_kernels_core::ir::Op::Store {
            dst: "out".into(),
            indices: vec![ffai_kernels_core::ir::IndexExpr::Value(used_vid)],
            value: used_vid,
            mask: None,
        });
        results.push(None);
