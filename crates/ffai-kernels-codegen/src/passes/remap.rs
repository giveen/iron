...
use ffai_kernels_core::ir::{Kernel, Op, ValueId};
...
pub fn all_block_ids(kernel: &Kernel) -> Vec<ffai_kernels_core::ir::BlockId> {
    let mut ids: Vec<ffai_kernels_core::ir::BlockId> = kernel.blocks.keys().copied().collect();
...
#[cfg(test)]
mod tests {
    use ffai_kernels_core::ir::{BinOpKind, IndexExpr};
    ...
    fn all_op_variants_covered() {
        ...
        let mut op = Op::StrideReduce {
            ...
            op: ffai_kernels_core::ir::ReduceKind::Sum,
            dtype: ffai_kernels_core::dtype::DType::F32,
            transform: None,
            secondary_src: None,
        ...
        k.body.push_op(
            Op::FusedElementwise {
                ops: vec![
                    ...
                    Op::UnaryOp {
                        op: ffai_kernels_core::ir::UnaryOpKind::Neg,
                        value: sub_op_ref_0,
                    },
                ],
            },
