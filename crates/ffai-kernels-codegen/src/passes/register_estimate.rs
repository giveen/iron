...
use ffai_kernels_core::ir::{Kernel, ValueId};
...
fn block_max_live(block: &ffai_kernels_core::ir::Block) -> usize {
...
#[cfg(test)]
mod tests {
    use ffai_kernels_core::ir::{BinOpKind, Op};
    ...
    fn block_max_live_btree(block: &ffai_kernels_core::ir::Block) -> usize {
