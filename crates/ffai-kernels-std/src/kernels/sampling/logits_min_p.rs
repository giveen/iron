...
#[kernel]
pub fn ffai_logits_min_p_mask<T>(
    inp: Tensor<T>,
    out: Tensor<T>,
    #[constexpr] n: u32,
    #[constexpr] min_p: f32,
...
pub mod kernel_tests {
    ...
    use super::ffai_logits_min_p_mask;
    ...
    fn test_logits_min_p_mask(dt: DType) -> TestSetup {
        ...
        TestSetup::new(ffai_logits_min_p_mask::kernel_ir_for(dt))
...
/// New-syntax benchmark for `ffai_logits_min_p_mask` at Qwen3 vocab scale
...
pub mod kernel_benches {
    ...
    fn bench_logits_min_p_mask(dt: DType) -> BenchSetup {
        ...
        BenchSetup::new(ffai_logits_min_p_mask::kernel_ir_for(dt))
            .mode(KernelMode::Reduction)
