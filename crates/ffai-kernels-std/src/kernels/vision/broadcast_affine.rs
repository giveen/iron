...
#[kernel]
pub fn ffai_broadcast_affine<T>(
    input: Tensor<T>,
    scale: Tensor<T>,
    bias: Tensor<T>,
    out: Tensor<T>,
...
pub mod kernel_tests {
    ...
    use super::ffai_broadcast_affine;
    ...
    fn setup(dt: DType, rows: usize, channels: usize) -> TestSetup {
        ...
        TestSetup::new(ffai_broadcast_affine::kernel_ir_for(dt))
...
pub mod kernel_benches {
    ...
    fn bench_broadcast_affine(dt: DType) -> BenchSetup {
        ...
        let n = rows * channels;
        BenchSetup::new(ffai_broadcast_affine::kernel_ir_for(dt))
            .mode(KernelMode::Grid3D)
