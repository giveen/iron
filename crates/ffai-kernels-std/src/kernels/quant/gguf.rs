...
//!
//! [`QFormat`] is ffai-kernels's **own** block-scaled layout: *planar*
//! (`codes[]` + `scales[]`), *symmetric* (`element · block_scale · global`, no
//! zero-point), packed end-to-end by ffai-kernels. GGUF formats are
...
/// callers have a single registry of the GGUF precisions ffai-kernels supports.
