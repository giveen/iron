...
//! Confirm against Hy3 golden logits before FFAI wires this path exclusively
...
/// Feeds `ffai_moe_router_topk_biased` (top-k by biased, weights from unbiased) so the whole
...
pub mod kernel_tests {
    ...
    use super::ffai_moe_sigmoid_bias;
    ...
    fn setup(n_experts: usize) -> TestSetup {
        ...
        TestSetup::new(ffai_moe_sigmoid_bias::kernel_ir())
