...
//! Expert-outer MoE gather QMM (MPP) — `ffai_moe_gather_qmm_mma_int{2,4,8}_expert_grid_mpp`.
//!
...
pub fn ffai_moe_gather_qmm_mma_eg<T>(
    x: Tensor<T>,
    w: Tensor<u32>,
    scales: Tensor<T>,
    biases: Tensor<T>,
...
mod tests {
    ...
    fn kernel_ir_constructs() {
        let k = ffai_moe_gather_qmm_mma_eg_int2_expert_grid_mpp::kernel_ir_for(DType::BF16);
    ...
    fn codegen_emits_mpp() {
        let k = ffai_moe_gather_qmm_mma_eg_int2_expert_grid_mpp::kernel_ir_for(DType::F32);
...
pub mod kernel_tests {
    ...
    use super::{
        ffai_moe_gather_qmm_mma_eg_int2_expert_grid_mpp,
        ffai_moe_gather_qmm_mma_eg_int4_expert_grid_mpp,
        ffai_moe_gather_qmm_mma_eg_int8_expert_grid_mpp,
    };
    ...
    fn test_moe_gather_qmm_mma_int2_expert_grid_mpp(dt: DType) -> TestSetup {
        ...
        let mut setup = int2_indexed_setup(
            ffai_moe_gather_qmm_mma_eg_int2_expert_grid_mpp::kernel_ir_for(dt),
            shape,
            32, // bn
    ...
    fn test_moe_gather_qmm_mma_int4_expert_grid_mpp(dt: DType) -> TestSetup {
        let shape = MmaTestShape { n_experts: 4, m_total: 64, n_out: 64, k_in: 64, group_size: 32 };
        int4_indexed_setup(
            ffai_moe_gather_qmm_mma_eg_int4_expert_grid_mpp::kernel_ir_for(dt),
            shape,
            32,
            16,
            32,
    ...
    fn test_moe_gather_qmm_mma_int8_expert_grid_mpp(dt: DType) -> TestSetup {
        let shape = MmaTestShape { n_experts: 4, m_total: 64, n_out: 64, k_in: 64, group_size: 32 };
        int8_indexed_setup(
            ffai_moe_gather_qmm_mma_eg_int8_expert_grid_mpp::kernel_ir_for(dt),
            shape,
            32,
            16,
            32,
...
pub mod kernel_benches {
    ...
    use super::ffai_moe_gather_qmm_mma_eg_int2_expert_grid_mpp;
    ...
    fn bench_moe_gather_qmm_mma_int2_expert_grid_mpp(dt: DType) -> BenchSetup {
        ...
        let bytes = (active * n_out * words_per_row * 4)
            ...
            + m_total * k_in * sz
            + m_total * n_out * sz;
        BenchSetup::new(ffai_moe_gather_qmm_mma_eg_int2_expert_grid_mpp::kernel_ir_for(dt))
