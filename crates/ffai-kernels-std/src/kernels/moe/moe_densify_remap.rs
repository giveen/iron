...
#[kernel]
pub fn ffai_moe_densify_int2_experts(
...
#[kernel]
pub fn ffai_moe_remap_experts_dense(
...
pub mod kernel_tests {
    ...
    use super::{ffai_moe_densify_int2_experts, ffai_moe_remap_experts_dense};
    ...
    fn test_moe_remap_experts_dense(_dt: DType) -> TestSetup {
        ...
        TestSetup::new(ffai_moe_remap_experts_dense::kernel_ir())
    ...
    fn test_moe_densify_int2_experts(dt: DType) -> TestSetup {
        ...
        TestSetup::new(ffai_moe_densify_int2_experts::kernel_ir())
...
pub mod kernel_benches {
    ...
    fn bench_moe_remap_experts_dense(_dt: DType) -> BenchSetup {
        ...
        BenchSetup::new(ffai_moe_remap_experts_dense::kernel_ir())
    ...
    fn bench_moe_densify_int2_experts(dt: DType) -> BenchSetup {
        ...
        BenchSetup::new(ffai_moe_densify_int2_experts::kernel_ir())
