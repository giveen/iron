...
//! MPP-backed MoE grouped int4 BGEMM — `ffai_moe_gather_qmm_mma_int4_bm8_mpp`.
//!
//! BM=8 sibling of `ffai_moe_gather_qmm_mma_int4_bm16_mpp`. Same algorithm
...
mod tests {
    ...
    fn kernel_ir_constructs_and_uses_coop_tile_ops() {
        for dt in [DType::F32, DType::F16, DType::BF16] {
            let k = ffai_moe_gather_qmm_mma_int4_bm8_mpp::kernel_ir_for(dt);
    ...
    fn bf16_stages_through_half() {
        let k = ffai_moe_gather_qmm_mma_int4_bm8_mpp::kernel_ir_for(DType::BF16);
...
pub mod kernel_tests {
    ...
    fn test_moe_gather_qmm_mma_int4_bm8_mpp(dt: DType) -> TestSetup {
        int4_indexed_setup(
            ffai_moe_gather_qmm_mma_int4_bm8_mpp::kernel_ir_for(dt),
            MmaTestShape { n_experts: 4, m_total: 64, n_out: 64, k_in: 64, group_size: 32 },
            32,
            8,
            32,
    ...
    fn test_moe_gather_qmm_mma_int8_bm8_mpp(dt: DType) -> TestSetup {
        int8_indexed_setup(
            ffai_moe_gather_qmm_mma_int8_bm8_mpp::kernel_ir_for(dt),
            MmaTestShape { n_experts: 4, m_total: 64, n_out: 64, k_in: 64, group_size: 32 },
            32,
            8,
            32,
