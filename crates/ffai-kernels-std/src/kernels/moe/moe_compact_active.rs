...
#[kernel]
pub fn ffai_moe_compact_active_experts(
...
pub mod kernel_tests {
    ...
    use super::ffai_moe_compact_active_experts;
    ...
    fn test_moe_compact_active_experts(_dt: DType) -> TestSetup {
        ...
        TestSetup::new(ffai_moe_compact_active_experts::kernel_ir())
...
pub mod kernel_benches {
    ...
    fn bench_moe_compact_active_experts(_dt: DType) -> BenchSetup {
        ...
        let cap = 128usize;
        BenchSetup::new(ffai_moe_compact_active_experts::kernel_ir())
