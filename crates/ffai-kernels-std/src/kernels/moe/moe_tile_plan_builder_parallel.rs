...
//! follow-up). `ffai_moe_build_tile_plan_parallel`.
//!
//! Pairs with `ffai_moe_tile_plan_expert_counts`
...
//! `n_experts` lanes - same shape as `ffai_moe_build_tile_plan`
...
//!
//! Output format is IDENTICAL to `ffai_moe_build_tile_plan`: same
...
#[kernel]
pub fn ffai_moe_build_tile_plan_parallel(
...
mod tests {
    ...
    fn kernel_ir_constructs_without_inline_msl() {
        let k = ffai_moe_build_tile_plan_parallel::kernel_ir();
        assert_eq!(k.name, "ffai_moe_build_tile_plan_parallel");
        let all_ops =
...
pub mod kernel_benches {
    ...
    use super::ffai_moe_build_tile_plan_parallel;
    ...
    fn bench_moe_build_tile_plan_parallel(_dt: DType) -> BenchSetup {
        ...
        BenchSetup::new(ffai_moe_build_tile_plan_parallel::kernel_ir())
