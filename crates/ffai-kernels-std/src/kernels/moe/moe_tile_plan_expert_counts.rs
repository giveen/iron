...
//! follow-up). `ffai_moe_tile_plan_expert_counts`.
//!
//! The existing tile-plan builders (`ffai_moe_build_tile_plan`,
...
//! `sorted_experts`. `ffai_moe_tile_plan_expert_counts` dispatches ONE
...
//! one-threadgroup-per-expert idiom `ffai_moe_gather_qmm_mma_eg_*`
...
//! `ffai_moe_sort_plan_hist` -> `ffai_moe_sort_plan_offsets` already
...
/// variants.
#[kernel]
pub fn ffai_moe_tile_plan_expert_counts(
...
mod tests {
    ...
    fn kernel_ir_constructs_without_inline_msl() {
        let k = ffai_moe_tile_plan_expert_counts::kernel_ir();
        assert_eq!(k.name, "ffai_moe_tile_plan_expert_counts");
        let all_ops =
...
pub mod kernel_benches {
    ...
    use super::ffai_moe_tile_plan_expert_counts;
    ...
    fn bench_moe_tile_plan_expert_counts(_dt: DType) -> BenchSetup {
        ...
        BenchSetup::new(ffai_moe_tile_plan_expert_counts::kernel_ir())
