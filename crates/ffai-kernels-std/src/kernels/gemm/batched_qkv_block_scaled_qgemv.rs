...
/// `kernels/primitives.rs`. Produces `ffai_<FMT>_batched_qkv_qgemv`.
#[kernel(variants(
...
pub mod kernel_tests {
    ...
    fn test_mxfp4_batched_qkv_qgemv(dt: DType) -> TestSetup {
        qkv_setup(
            ffai_mxfp4_batched_qkv_qgemv::kernel_ir_for(dt),
            QFormat::Mxfp4,
            16,
            4,
            4,
    ...
    fn test_nvfp4_batched_qkv_qgemv(dt: DType) -> TestSetup {
        qkv_setup(
            ffai_nvfp4_batched_qkv_qgemv::kernel_ir_for(dt),
            QFormat::Nvfp4,
            16,
            4,
            4,
    ...
    fn test_mxfp8_e4m3_batched_qkv_qgemv(dt: DType) -> TestSetup {
        qkv_setup(
            ffai_mxfp8_e4m3_batched_qkv_qgemv::kernel_ir_for(dt),
            QFormat::Mxfp8E4,
            16,
            4,
            4,
    ...
    fn test_mxfp8_e5m2_batched_qkv_qgemv(dt: DType) -> TestSetup {
        qkv_setup(
            ffai_mxfp8_e5m2_batched_qkv_qgemv::kernel_ir_for(dt),
            QFormat::Mxfp8E5,
            16,
            4,
            4,
    ...
    fn test_nvfp8_batched_qkv_qgemv(dt: DType) -> TestSetup {
        qkv_setup(
            ffai_nvfp8_batched_qkv_qgemv::kernel_ir_for(dt),
            QFormat::Nvfp8,
            16,
            4,
            4,
    ...
    fn test_fp4_batched_qkv_qgemv(dt: DType) -> TestSetup {
        qkv_setup(ffai_fp4_batched_qkv_qgemv::kernel_ir_for(dt), QFormat::Fp4, 16, 4, 4, 256, dt)
    }
    ...
    fn test_fp8_e5m2_batched_qkv_qgemv(dt: DType) -> TestSetup {
        qkv_setup(
            ffai_fp8_e5m2_batched_qkv_qgemv::kernel_ir_for(dt),
            QFormat::Fp8E5m2,
            16,
            4,
            4,
    ...
    fn test_int8_batched_qkv_qgemv(dt: DType) -> TestSetup {
        qkv_setup(ffai_int8_batched_qkv_qgemv::kernel_ir_for(dt), QFormat::Int8, 16, 4, 4, 256, dt)
    }
    ...
    fn test_int2_batched_qkv_qgemv(dt: DType) -> TestSetup {
        qkv_setup(ffai_int2_batched_qkv_qgemv::kernel_ir_for(dt), QFormat::Int2, 16, 4, 4, 256, dt)
    }
    #[test_kernel(dtypes = [f32, f16, bf16], tol = [5e-3, 5e-2, 2e-1])]
    fn test_int3_batched_qkv_qgemv(dt: DType) -> TestSetup {
        qkv_setup(ffai_int3_batched_qkv_qgemv::kernel_ir_for(dt), QFormat::Int3, 16, 4, 4, 256, dt)
    }
    #[test_kernel(dtypes = [f32, f16, bf16], tol = [5e-3, 5e-2, 2e-1])]
    fn test_int4_batched_qkv_qgemv(dt: DType) -> TestSetup {
        qkv_setup(ffai_int4_batched_qkv_qgemv::kernel_ir_for(dt), QFormat::Int4, 16, 4, 4, 256, dt)
    }
    #[test_kernel(dtypes = [f32, f16, bf16], tol = [5e-3, 5e-2, 2e-1])]
    fn test_int5_batched_qkv_qgemv(dt: DType) -> TestSetup {
        qkv_setup(ffai_int5_batched_qkv_qgemv::kernel_ir_for(dt), QFormat::Int5, 16, 4, 4, 256, dt)
    }
    #[test_kernel(dtypes = [f32, f16, bf16], tol = [5e-3, 5e-2, 2e-1])]
    fn test_int6_batched_qkv_qgemv(dt: DType) -> TestSetup {
        qkv_setup(ffai_int6_batched_qkv_qgemv::kernel_ir_for(dt), QFormat::Int6, 16, 4, 4, 256, dt)
    }
    #[test_kernel(dtypes = [f32, f16, bf16], tol = [5e-3, 5e-2, 2e-1])]
    fn test_mxint2_batched_qkv_qgemv(dt: DType) -> TestSetup {
        qkv_setup(
            ffai_mxint2_batched_qkv_qgemv::kernel_ir_for(dt),
            QFormat::Mxint2,
            16,
            4,
            4,
    ...
    fn test_mxint3_batched_qkv_qgemv(dt: DType) -> TestSetup {
        qkv_setup(
            ffai_mxint3_batched_qkv_qgemv::kernel_ir_for(dt),
            QFormat::Mxint3,
            16,
            4,
            4,
    ...
    fn test_mxint4_batched_qkv_qgemv(dt: DType) -> TestSetup {
        qkv_setup(
            ffai_mxint4_batched_qkv_qgemv::kernel_ir_for(dt),
            QFormat::Mxint4,
            16,
            4,
            4,
    ...
    fn test_mxint5_batched_qkv_qgemv(dt: DType) -> TestSetup {
        qkv_setup(
            ffai_mxint5_batched_qkv_qgemv::kernel_ir_for(dt),
            QFormat::Mxint5,
            16,
            4,
            4,
    ...
    fn test_mxint6_batched_qkv_qgemv(dt: DType) -> TestSetup {
        qkv_setup(
            ffai_mxint6_batched_qkv_qgemv::kernel_ir_for(dt),
            QFormat::Mxint6,
            16,
            4,
            4,
    ...
    fn test_mxint8_batched_qkv_qgemv(dt: DType) -> TestSetup {
        qkv_setup(
            ffai_mxint8_batched_qkv_qgemv::kernel_ir_for(dt),
            QFormat::Mxint8,
            16,
            4,
            4,
    ...
    fn test_nvfp8_f16_batched_qkv_qgemv(dt: DType) -> TestSetup {
        qkv_setup(
            ffai_nvfp8_f16_batched_qkv_qgemv::kernel_ir_for(dt),
            QFormat::Nvfp8F16,
            16,
            4,
            4,
    ...
    fn test_fp4_f16_batched_qkv_qgemv(dt: DType) -> TestSetup {
        qkv_setup(
            ffai_fp4_f16_batched_qkv_qgemv::kernel_ir_for(dt),
            QFormat::Fp4F16,
            16,
            4,
            4,
    ...
    fn test_fp8_e5m2_f16_batched_qkv_qgemv(dt: DType) -> TestSetup {
        qkv_setup(
            ffai_fp8_e5m2_f16_batched_qkv_qgemv::kernel_ir_for(dt),
            QFormat::Fp8E5m2F16,
            16,
            4,
            4,
    ...
    fn test_int2_f16_batched_qkv_qgemv(dt: DType) -> TestSetup {
        qkv_setup(
            ffai_int2_f16_batched_qkv_qgemv::kernel_ir_for(dt),
            QFormat::Int2F16,
            16,
            4,
            4,
    ...
    fn test_int3_f16_batched_qkv_qgemv(dt: DType) -> TestSetup {
        qkv_setup(
            ffai_int3_f16_batched_qkv_qgemv::kernel_ir_for(dt),
            QFormat::Int3F16,
            16,
            4,
            4,
    ...
    fn test_int4_f16_batched_qkv_qgemv(dt: DType) -> TestSetup {
        qkv_setup(
            ffai_int4_f16_batched_qkv_qgemv::kernel_ir_for(dt),
            QFormat::Int4F16,
            16,
            4,
            4,
    ...
    fn test_int5_f16_batched_qkv_qgemv(dt: DType) -> TestSetup {
        qkv_setup(
            ffai_int5_f16_batched_qkv_qgemv::kernel_ir_for(dt),
            QFormat::Int5F16,
            16,
            4,
            4,
    ...
    fn test_int6_f16_batched_qkv_qgemv(dt: DType) -> TestSetup {
        qkv_setup(
            ffai_int6_f16_batched_qkv_qgemv::kernel_ir_for(dt),
            QFormat::Int6F16,
            16,
            4,
            4,
    ...
    fn test_int8_f16_batched_qkv_qgemv(dt: DType) -> TestSetup {
        qkv_setup(
            ffai_int8_f16_batched_qkv_qgemv::kernel_ir_for(dt),
            QFormat::Int8F16,
            16,
            4,
            4,
...
pub mod kernel_benches {
    ...
    fn bench_fp4_qkv(dt: DType) -> BenchSetup {
        qkv_bench(
            ffai_fp4_batched_qkv_qgemv::kernel_ir_for(dt),
            QFormat::Fp4,
            4096,
            1024,
            1024,
    ...
    fn bench_int8_qkv(dt: DType) -> BenchSetup {
        qkv_bench(
            ffai_int8_batched_qkv_qgemv::kernel_ir_for(dt),
            QFormat::Int8,
            4096,
            1024,
            1024,
    ...
    fn bench_int2_qkv(dt: DType) -> BenchSetup {
        qkv_bench(
            ffai_int2_batched_qkv_qgemv::kernel_ir_for(dt),
            QFormat::Int2,
            4096,
            1024,
            1024,
    ...
    fn bench_int3_qkv(dt: DType) -> BenchSetup {
        qkv_bench(
            ffai_int3_batched_qkv_qgemv::kernel_ir_for(dt),
            QFormat::Int3,
            4096,
            1024,
            1024,
    ...
    fn bench_int4_qkv(dt: DType) -> BenchSetup {
        qkv_bench(
            ffai_int4_batched_qkv_qgemv::kernel_ir_for(dt),
            QFormat::Int4,
            4096,
            1024,
            1024,
    ...
    fn bench_int5_qkv(dt: DType) -> BenchSetup {
        qkv_bench(
            ffai_int5_batched_qkv_qgemv::kernel_ir_for(dt),
            QFormat::Int5,
            4096,
            1024,
            1024,
    ...
    fn bench_int6_qkv(dt: DType) -> BenchSetup {
        qkv_bench(
            ffai_int6_batched_qkv_qgemv::kernel_ir_for(dt),
            QFormat::Int6,
            4096,
            1024,
            1024,
