...
//! `ffai_*_batched_qkv_qgemv` rather than the perf-tuned mask-without-shift path.
//!
...
/// `kernels/primitives.rs`. Produces `ffai_<FMT>_batched_4_qgemv`.
#[kernel(variants(
...
pub mod kernel_tests {
    ...
    fn test_mxfp4_batched_4_qgemv(dt: DType) -> TestSetup {
        batched_4_setup(
            ffai_mxfp4_batched_4_qgemv::kernel_ir_for(dt),
            QFormat::Mxfp4,
            16,
            4,
            4,
    ...
    fn test_nvfp4_batched_4_qgemv(dt: DType) -> TestSetup {
        batched_4_setup(
            ffai_nvfp4_batched_4_qgemv::kernel_ir_for(dt),
            QFormat::Nvfp4,
            16,
            4,
            4,
    ...
    fn test_mxfp8_e4m3_batched_4_qgemv(dt: DType) -> TestSetup {
        batched_4_setup(
            ffai_mxfp8_e4m3_batched_4_qgemv::kernel_ir_for(dt),
            QFormat::Mxfp8E4,
            16,
            4,
            4,
    ...
    fn test_mxfp8_e5m2_batched_4_qgemv(dt: DType) -> TestSetup {
        batched_4_setup(
            ffai_mxfp8_e5m2_batched_4_qgemv::kernel_ir_for(dt),
            QFormat::Mxfp8E5,
            16,
            4,
            4,
    ...
    fn test_nvfp8_batched_4_qgemv(dt: DType) -> TestSetup {
        batched_4_setup(
            ffai_nvfp8_batched_4_qgemv::kernel_ir_for(dt),
            QFormat::Nvfp8,
            16,
            4,
            4,
    ...
    fn test_fp4_batched_4_qgemv(dt: DType) -> TestSetup {
        batched_4_setup(
            ffai_fp4_batched_4_qgemv::kernel_ir_for(dt),
            QFormat::Fp4,
            16,
            4,
            4,
    ...
    fn test_fp8_e5m2_batched_4_qgemv(dt: DType) -> TestSetup {
        batched_4_setup(
            ffai_fp8_e5m2_batched_4_qgemv::kernel_ir_for(dt),
            QFormat::Fp8E5m2,
            16,
            4,
            4,
    ...
    fn test_int8_batched_4_qgemv(dt: DType) -> TestSetup {
        batched_4_setup(
            ffai_int8_batched_4_qgemv::kernel_ir_for(dt),
            QFormat::Int8,
            16,
            4,
            4,
    ...
    fn test_int2_batched_4_qgemv(dt: DType) -> TestSetup {
        batched_4_setup(
            ffai_int2_batched_4_qgemv::kernel_ir_for(dt),
            QFormat::Int2,
            16,
            4,
            4,
    ...
    fn test_int3_batched_4_qgemv(dt: DType) -> TestSetup {
        batched_4_setup(
            ffai_int3_batched_4_qgemv::kernel_ir_for(dt),
            QFormat::Int3,
            16,
            4,
            4,
    ...
    fn test_int4_batched_4_qgemv(dt: DType) -> TestSetup {
        batched_4_setup(
            ffai_int4_batched_4_qgemv::kernel_ir_for(dt),
            QFormat::Int4,
            16,
            4,
            4,
    ...
    fn test_int5_batched_4_qgemv(dt: DType) -> TestSetup {
        batched_4_setup(
            ffai_int5_batched_4_qgemv::kernel_ir_for(dt),
            QFormat::Int5,
            16,
            4,
            4,
    ...
    fn test_int6_batched_4_qgemv(dt: DType) -> TestSetup {
        batched_4_setup(
            ffai_int6_batched_4_qgemv::kernel_ir_for(dt),
            QFormat::Int6,
            16,
            4,
            4,
    ...
    fn test_mxint2_batched_4_qgemv(dt: DType) -> TestSetup {
        batched_4_setup(
            ffai_mxint2_batched_4_qgemv::kernel_ir_for(dt),
            QFormat::Mxint2,
            16,
            4,
            4,
    ...
    fn test_mxint3_batched_4_qgemv(dt: DType) -> TestSetup {
        batched_4_setup(
            ffai_mxint3_batched_4_qgemv::kernel_ir_for(dt),
            QFormat::Mxint3,
            16,
            4,
            4,
    ...
    fn test_mxint4_batched_4_qgemv(dt: DType) -> TestSetup {
        batched_4_setup(
            ffai_mxint4_batched_4_qgemv::kernel_ir_for(dt),
            QFormat::Mxint4,
            16,
            4,
            4,
    ...
    fn test_mxint5_batched_4_qgemv(dt: DType) -> TestSetup {
        batched_4_setup(
            ffai_mxint5_batched_4_qgemv::kernel_ir_for(dt),
            QFormat::Mxint5,
            16,
            4,
            4,
    ...
    fn test_mxint6_batched_4_qgemv(dt: DType) -> TestSetup {
        batched_4_setup(
            ffai_mxint6_batched_4_qgemv::kernel_ir_for(dt),
            QFormat::Mxint6,
            16,
            4,
            4,
    ...
    fn test_mxint8_batched_4_qgemv(dt: DType) -> TestSetup {
        batched_4_setup(
            ffai_mxint8_batched_4_qgemv::kernel_ir_for(dt),
            QFormat::Mxint8,
            16,
            4,
            4,
    ...
    fn test_nvfp8_f16_batched_4_qgemv(dt: DType) -> TestSetup {
        batched_4_setup(
            ffai_nvfp8_f16_batched_4_qgemv::kernel_ir_for(dt),
            QFormat::Nvfp8F16,
            16,
            4,
            4,
    ...
    fn test_fp4_f16_batched_4_qgemv(dt: DType) -> TestSetup {
        batched_4_setup(
            ffai_fp4_f16_batched_4_qgemv::kernel_ir_for(dt),
            QFormat::Fp4F16,
            16,
            4,
            4,
    ...
    fn test_fp8_e5m2_f16_batched_4_qgemv(dt: DType) -> TestSetup {
        batched_4_setup(
            ffai_fp8_e5m2_f16_batched_4_qgemv::kernel_ir_for(dt),
            QFormat::Fp8E5m2F16,
            16,
            4,
            4,
    ...
    fn test_int2_f16_batched_4_qgemv(dt: DType) -> TestSetup {
        batched_4_setup(
            ffai_int2_f16_batched_4_qgemv::kernel_ir_for(dt),
            QFormat::Int2F16,
            16,
            4,
            4,
    ...
    fn test_int3_f16_batched_4_qgemv(dt: DType) -> TestSetup {
        batched_4_setup(
            ffai_int3_f16_batched_4_qgemv::kernel_ir_for(dt),
            QFormat::Int3F16,
            16,
            4,
            4,
    ...
    fn test_int4_f16_batched_4_qgemv(dt: DType) -> TestSetup {
        batched_4_setup(
            ffai_int4_f16_batched_4_qgemv::kernel_ir_for(dt),
            QFormat::Int4F16,
            16,
            4,
            4,
    ...
    fn test_int5_f16_batched_4_qgemv(dt: DType) -> TestSetup {
        batched_4_setup(
            ffai_int5_f16_batched_4_qgemv::kernel_ir_for(dt),
            QFormat::Int5F16,
            16,
            4,
            4,
    ...
    fn test_int6_f16_batched_4_qgemv(dt: DType) -> TestSetup {
        batched_4_setup(
            ffai_int6_f16_batched_4_qgemv::kernel_ir_for(dt),
            QFormat::Int6F16,
            16,
            4,
            4,
    ...
    fn test_int8_f16_batched_4_qgemv(dt: DType) -> TestSetup {
        batched_4_setup(
            ffai_int8_f16_batched_4_qgemv::kernel_ir_for(dt),
            QFormat::Int8F16,
            16,
            4,
            4,
