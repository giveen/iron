...
#[kernel]
pub fn ffai_depthwise_conv1d<T>(
    input: Tensor<T>,
    weight: Tensor<T>,
    bias: Tensor<T>,
    out: Tensor<T>,
...
pub mod kernel_tests {
    ...
    use super::ffai_depthwise_conv1d;
    ...
    fn setup(
        ...
        TestSetup::new(ffai_depthwise_conv1d::kernel_ir_for(dt))
...
pub mod kernel_benches {
    ...
    fn bench_depthwise_conv1d(dt: DType) -> BenchSetup {
        ...
        BenchSetup::new(ffai_depthwise_conv1d::kernel_ir_for(dt))
            .mode(KernelMode::Grid3D)
