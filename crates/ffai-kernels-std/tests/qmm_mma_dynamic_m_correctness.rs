...
//!
//! Run:
//!   cargo test --release -p ffai-kernels-std --test qmm_mma_dynamic_m_correctness -- --nocapture
...
use common::gpu_lock;
use ffai_kernels::{Context, core::dtype::DType};
use ffai_kernels_std::kernels::gemm::quantized_mma_dynamic_m as dyn_m;
