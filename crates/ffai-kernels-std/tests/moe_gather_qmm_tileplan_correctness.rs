...
//! GPU correctness for `ffai_moe_gather_qmm_mma_int4_bm16_mpp_tileplan`
...
use ffai_kernels_std::kernels::moe::moe_mpp_tileplan::{
    build_tile_plan,
    ffai_moe_gather_qmm_mma_int4_bm16_mpp_tileplan,
};
...
fn run_tileplan(
    ...
    let mut k = ffai_moe_gather_qmm_mma_int4_bm16_mpp_tileplan::kernel_ir_for(dt.to_dtype());
