...
//! GPU correctness for `ffai_moe_build_tile_plan_bm32_paired` (the device
//! PAIR-ONLY tile-plan builder feeding `ffai_moe_gather_qmm_coop_paired`).
//!
...
//! `ffai_moe_build_tile_plan_bm32` / `ffai_moe_gather_qmm_coop` path
...
use ffai_kernels_std::kernels::moe::{
    moe_tile_plan_builder_bm32_paired::ffai_moe_build_tile_plan_bm32_paired,
...
fn run_case_with_pair_counts(
    ...
    let mut k = ffai_moe_build_tile_plan_bm32_paired::kernel_ir();
