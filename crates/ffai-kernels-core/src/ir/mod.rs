...
//! FFAI Kernels IR: SSA-form intermediate representation for tile-level kernels.
//!
...
//! The schedule IR (in `ffai-kernels-codegen`) annotates ops with *how* to compute it:
...
// Flat re-exports so existing `use ffai_kernels_core::ir::*` paths remain valid.
