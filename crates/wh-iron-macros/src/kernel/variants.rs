...
pub(crate) enum VariantValue {
    ...
    /// making kernel names like `iron_conv1d_block_scaled_0_mxfp4` instead of
    /// `iron_conv1d_block_scaled_0_0`.
    Named {
...
mod tests {
    ...
    fn substitute_fn_correct_name_and_body() {
        ...
        .unwrap();
        assert_eq!(result.sig.ident.to_string(), "iron_moe_m16");
    ...
    fn optional_constexpr_end_to_end_in_substitute_fn() {
        ...
        assert_eq!(result.sig.ident.to_string(), "iron_d0");
    }
}
