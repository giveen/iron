...
//!
//! The generated `impl Op` methods reference these `wh_iron_core` symbols
//! through `quote!` tokens — if any are renamed in `wh-iron-core`, the
//! consumer's rustc error will point at generated code.  Keep this list in
//! sync:
//!
//! - `::smallvec::SmallVec`
//! - `ValueId` (bare name, imported from `wh_iron_core::ir`)
