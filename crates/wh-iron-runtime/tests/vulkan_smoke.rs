...
use wh_iron_codegen::{CodegenBackend, GlslGenerator};
use wh_iron_core::{
    constexpr::ConstExpr,
    dtype::DType,
    ir::{
...
use wh_iron_runtime::VulkanDevice;
...
fn shaderc_glsl_to_spv_for_vector_add() {
    ...
    let spv =
        wh_iron_runtime::compile_glsl_to_spv(&glsl, "vector_add.comp").expect("shaderc compile");
