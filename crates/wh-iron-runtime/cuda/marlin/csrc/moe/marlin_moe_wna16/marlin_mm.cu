...
MarlinFuncPtr get_marlin_kernel(
    const marlin_types::ScalarType a_type, const marlin_types::ScalarType b_type,
    const marlin_types::ScalarType c_type, const marlin_types::ScalarType s_type,
...
exec_config_t determine_exec_config(
    const marlin_types::ScalarType& a_type, const marlin_types::ScalarType& b_type,
    const marlin_types::ScalarType& c_type, const marlin_types::ScalarType& s_type, int prob_m,
...
void marlin_mm(const void* A, const void* B, void* C, void* C_tmp, void* b_bias,
               ...
               int prob_k, void* workspace, marlin_types::ScalarType const& a_type,
               marlin_types::ScalarType const& b_type, marlin_types::ScalarType const& c_type,
               marlin_types::ScalarType const& s_type, bool has_bias,
  ...
  if (major_capability == 7 && minor_capability == 5) {
    stages = 2;
    TORCH_CHECK(a_type == marlin_types::kFloat16 || a_type == marlin_types::kS8,
                "Turing only support FP16 or INT8 activation.");
  }
  if (a_type == marlin_types::kFE4M3fn) {
