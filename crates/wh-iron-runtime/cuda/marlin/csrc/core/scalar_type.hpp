...
//
//  Kernel-format provenance: this is a from-scratch C++ port of the public
//  GPTQ-Marlin ScalarType/ScalarTypeId convention (a compact signedness +
//  exponent/mantissa-bits + bias + finite-only encoding); it names a
//  kernel/pack format, not a project dependency.
//
class ScalarType {
 public:
