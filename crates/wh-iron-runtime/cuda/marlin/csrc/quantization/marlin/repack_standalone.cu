...
// raw launcher (torch-free): repack one [size_k/8, size_n] uint32 weight -> marlin layout
void run_repack(const unsigned* b_q_weight, unsigned* out, int size_k, int size_n,
  ...
  marlin::gptq_marlin_repack_kernel<marlin::repack_threads, 4, false, false>
      <<<blocks, marlin::repack_threads, max_shared_mem, stream>>>(
          b_q_weight, nullptr, out, size_k, size_n);
}
