            ...
            match op {
                ...
                Op::CoopTileSetup {
                    ...
                    let acc_mode_s = match acc_mode {
                        wh_iron_core::ir::CoopTileAccMode::Overwrite => "mode::multiply",
                        wh_iron_core::ir::CoopTileAccMode::MultiplyAccumulate =>
                ...
                Op::Atomic { op: ak, scope, dst, index, value } => {
                    ...
                    let rv = self.vname(Some(*value), block, extra_names);
                    match scope {
                        wh_iron_core::ir::AtomicScope::Device => {
                            wl!(
                                out,
                        ...
                        wh_iron_core::ir::AtomicScope::Threadgroup => {
                ...
                // cross-lane communication at all) — `iron_scan_f32`'s
                ...
                Op::SimdReduce { value, op: rk } => {
                    ...
                    match rk {
                        ...
                        ReduceKind::Product => {
                            wl!(out, "{pad}float {v} = __iron_simd_product(float({rv}));")
                        },
                    }
                },
