...
mod tests {
    ...
    // ── test 1: Value arg — scalar callee (iron_silu pattern) ──────────────────

    /// Caller passes a pre-computed f32 scalar to iron_silu via Value arg.
