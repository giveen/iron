...
//!
//! Import this module with `use wh_iron::prelude::*;` in the same Rust module as your kernels.
...
//!
//! For raw IR types (`Op`, `Block`, `ValueId`, etc.) use [`wh_iron::core::ir`] directly.
//! For codegen types (`MslGenerator`, `TileSchedule`, etc.) use [`wh_iron::codegen`] directly.
//!
//! # What's here
//!
