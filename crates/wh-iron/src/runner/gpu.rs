...
impl GpuRunner {
    pub fn new() -> Result<Self, String> {
        #[cfg(target_os = "macos")]
        {
            ...
            let slc_pso = inner
                .compile(SLC_FLUSH_MSL, "_iron_slc_flush")
...
/// `iron.toml` `warmup_runs` / `runs` to override the compile-time defaults.
#[allow(clippy::too_many_arguments)]
