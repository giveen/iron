...
//! Argument struct for the `__iron_runner` subprocess.
//!
//! The `iron` CLI serialises these as `--key value` flags when it spawns the
...
/// Parsed arguments for the `__iron_runner` subprocess.
#[derive(Debug, Clone)]
...
impl RunnerArgs {
    ...
    /// ```text
    /// __iron_runner bench [--filter <pat>] [--match-name <re>] [--no-match-name <re>]
    ///                     [--match-group <re>] [--no-match-group <re>]
    ///                     [--dtype <dt>] [--profile]
    ///                     [--warmup-runs <n>] [--runs <n>]
    /// __iron_runner test  [--filter <pat>] [--match-name <re>] [--dtype <dt>]
    /// __iron_runner build [--filter <pat>] [--dtype <dt>]
    /// __iron_runner inspect [--filter <pat>] [--kind <msl|ir|stats|listing>]
    /// ```
