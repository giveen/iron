...
//! Runner infrastructure for the `__iron_runner` subprocess.
//!
//! This module is the GPU-side half of the subprocess architecture.  The
//! `iron` CLI never imports anything from here — it only reads the
...
// wh-iron-runtime dep.  Device-capability queries go through here.
