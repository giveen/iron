...
/// → `mt_moe_gather_qmm_mma_int4_bm64_mpp` / `_int8_bm64_mpp`. Same weight-unpack
...
pub mod kernel_tests {
    ...
    use super::{mt_moe_gather_qmm_mma_int4_bm64_mpp, mt_moe_gather_qmm_mma_int8_bm64_mpp};
