...
//! # Writing kernels
//!
//! - Import `ffai_kernels::prelude::*` anywhere you define `#[kernel]` functions.
...
//! - Use `<kernel>::build_kernel_ir()` or `ffai_kernels::codegen::msl::MslGenerator` to inspect the
...
pub use ffai_kernels_codegen as codegen;
/// Error returned by `ffai_kernels::codegen` helpers.
pub use ffai_kernels_codegen::error::Error as CodegenError;
/// Core IR, dtype, shape, and constexpr definitions.
pub use ffai_kernels_core as core;
/// Proc macros and helper macros used by kernel definitions.
pub use ffai_kernels_macros::{
    bench,
    constexpr,
    kernel,
    scalar,
...
#[cfg(feature = "hip")]
pub use ffai_kernels_runtime::{HipBuffer, HipDevice, HipKernel, HipModuleHandle};
