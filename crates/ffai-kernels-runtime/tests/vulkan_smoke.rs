...
use ffai_kernels_codegen::{CodegenBackend, GlslGenerator};
...
use ffai_kernels_runtime::VulkanDevice;
...
fn shaderc_glsl_to_spv_for_vector_add() {
    ...
    let spv = ffai_kernels_runtime::compile_glsl_to_spv(&glsl, "vector_add.comp")
